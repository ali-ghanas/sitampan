	...
	$data = mysql_fetch_array($query);
        ...
        <input type="hidden" name="id" value="<?php echo  $data['idseksi']; ?>" />
            <table border="0">
                ...
                <tr>
                    <td>Jabatan</td><td>:</td>
                    <td ><input name="username" size="40" type="text" value="<?php echo  $data['jabatan']; ?>" disabled/></td>
                    <td ><input name="bidang" size="40" type="text" value="<?php echo  $data['bidang']; ?>" disabled/></td>
                </tr>
                <tr>
                    <td>Nama</td><td>:</td>
                ...
                <tr>
                    <td>Plh</td><td>:</td>
                    <td ><input class="required" name="plh" size="10" type="text" value="<?php echo  $data['plh']; ?>"/></td>
                </tr>
