...
session_start();
                ...
                $now=date('Y-m-d');
//sql mencari lengkap permohonan batal
			$sql1 = "SELECT * FROM bcf15,suratmasukpembatalanbcf15 WHERE suratmasukpembatalanbcf15.noidbcf15=bcf15.idbcf15 and idbcf15=$id"; 
			$lengkapbatal=mysql_fetch_array(mysql_query($sql1));
                                        ...
                                        <tr valign="top" class="isiform">
                                                <td width="50%" class="isitabel">
                                                    <table  >
                                                        ...
                                                        <tr>
                                                            <td colspan="4" style="text-decoration: none;color: #273372; font-weight: bolder;font-family: verdana;">Permohonan Diterima Lengkap</td>
                                                        </tr>
                                                        <tr >
                                                            <td class="isitabelnew">
                                                               Waktu Diterima Lengkap 
                                                            </td>
                                                            <td class="isitabelnew">:</td>
                                                            <td >
                                                               <?php echo $lengkapbatal['tgllengkap']; ?>   
                                                            </td>
                                                        </tr>
                                                         <tr>
