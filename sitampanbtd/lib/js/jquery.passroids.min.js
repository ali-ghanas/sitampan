...
var levels=new Array();levels[0]="Lemah";levels[1]="Sedang";levels[2]="Kuat";levels[3]="Sempurna";var strength=evalScore(s);jQuery('#psr_score').html('<span class="psr_'+levels[strength]+'"><strong>Strength:</strong> '+levels[strength]+'</span>');});if(o.verify!=null){jQuery(o.verify).keyup(function(){var main=jQuery(o.main).val();var verify=jQuery(o.verify).val();if(main==verify){jQuery('#psr_verify').html('');changeButtonState(1);}});jQuery(o.verify).blur(function(){var main=jQuery(o.main).val();var verify=jQuery(o.verify).val();if(main!=verify){jQuery('#psr_verify').html('Passwords do not match');changeButtonState(0);}});}});};