...
<html>
    ...
    <body>
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <table width="100%"><tr><td class="judultabel1">Daftar Permohonan Tunda Lelang (monitoring)</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=tundalelang"; ?> >
                    <table>
                        <tr>
                            <td><a href="?hal=tundalelang">Monitoring Tunda Lelang</a></td><td>|</td><td><a href="?hal=daf_intundalelang">Input Permohonan Tunda Lelang</a></td>
                        </tr>
                        <tr>
                        ...
                        if (isset($_POST['Bcf15no']))
                                        {
                                           ...
                                           {
                                                $bagianWhere .= "bcf15view.bcf15no LIKE '%$bcf15no%'";
                                           }
                                           else
                                           {
                                                $bagianWhere .= " AND bcf15view.bcf15no LIKE '%$bcf15no%'";
                                           }
                                        }
                                        if (isset($_POST['Tahun']))
                                        {
                                           ...
                                           if (empty($bagianWhere))
                                           {
                                                $bagianWhere .= "bcf15view.tahun='$tahun'";
                                           }
                                           else
                                           {
                                                $bagianWhere .= " AND bcf15view.tahun='$tahun'";
                                           }
                                        }
                    ...
                    $reload = "index.php?hal=tundalelang";

                    // data mentah 
                    $sql = "SELECT idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,tundalelang,tglsuratpermohonan,idstatusakhir,nosuratpermohonan,Pemohon
                        FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and recordstatus='2' and setujubatal='2' and tundalelang='1'  and ".$bagianWhere."   order by bcf15.idbcf15 desc ";
                    ...
                    $sqltampil = "SELECT idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,tundalelang,tglsuratpermohonan,idstatusakhir,nosuratpermohonan,Pemohon
                        FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and bcf15.idtpp=tpp.idtpp and  recordstatus='2' and setujubatal='2' and tundalelang='1'  and ".$bagianWhere."  order by bcf15.idbcf15 desc  LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,tundalelang,tglsuratpermohonan,idstatusakhir,nosuratpermohonan,Pemohon
                        FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode  and bcf15.idtpp=tpp.idtpp and recordstatus='2' and setujubatal='2' and tundalelang='1'  order by idbcf15 desc ";
                    $result = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,tundalelang,tglsuratpermohonan,idstatusakhir,nosuratpermohonan,Pemohon
                    FROM bcf15,tpp,typecode where bcf15.idtypecode=typecode.idtypecode  and bcf15.idtpp=tpp.idtpp and recordstatus='2' and setujubatal='2' and tundalelang='1'  order by idbcf15 desc  LIMIT $limit,$rpp" ;
        ...
        <br/>
                    ...
                    <table class="data" width="100%">
                            ...
                            <th class="judultabel">No Srt Tunda Lelang</th>
                            ...
                            <th class="judultabel">No Surat Permhn Btl BCF 1.5</th>
                            <th class="judultabel">Pemohon</th>
                            <th class="judultabel">Status Container</th>
                            <th class="judultabel">Status Permohonan Tunda Lelang (Max 60 hari)</th>
                    ...
                    while($data = mysql_fetch_array($tampil)){
                        ...
                        $tglbamasuk=$data['tglsuratpermohonan'];
                    ...
                    <td class="isitabel"><?php echo  $data['nosuratpermohonan']; ?></td>
                    <td class="isitabel"><?php echo  tglindo($data['tglsuratpermohonan']); ?></td>
                    ...
                    <td class="isitabel" align="center"><?php if ($selisihtpp >= '60') {echo "<font color=red><b>Permohonan Tunda Lelang Expired</b></font>";} else { echo  "$selisihtpp Hari" ;} ?></td>
                    <td align="center" class="isitabel"> <?php if ($data['idstatusakhir']=='9') {echo "BMN";}   elseif ($data['idstatusakhir']=='11') {echo 'Tunda Lelang'; } ?>
                    </td>
                    <td align="center" class="isitabel"> <?php if ($data['SuratBatalNo']=='') {echo "<a href='?hal=input_tundalelang&id=$data[idbcf15]' target='_self'><img src=\"images/new/update.png\" ></img></a> ";}   else {echo "<a href='?hal=input_tundalelang&id=$data[idbcf15]' target='_self'><img src=\"images/new/update.png\" ></img></a>"; } ?>
                    </td>
