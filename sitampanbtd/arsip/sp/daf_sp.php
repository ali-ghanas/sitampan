...
?>
    <br/>
    <div ><a href="?hal=page_arsip&pilih=input_sp">Form Upload SP</a> | <a href="?hal=page_arsip&pilih=browse_sp"><img src="images/new/cari.png" width="20"/>Tracking Arsip SP</a></div><br/>
<form method="post" action=<?php echo "index.php?hal=page_arsip&pilih=browse_sp"; ?> >
<table border="0" class="isitabel">
        <tr bgcolor="#000">
            <td colspan="3"><font color="#fff" size="4">Pencarian Arsip Surat Pengantar BCF 1.5 dari Seksi Administrasi Manifest Ke Seksi Tempat Penimbunan </font></td>
        </tr>
...
$reload = "index.php?hal=page_arsip&pilih=browse_sp";
...
<td align="center" class="isitabel"><a href="?hal=page_arsip&pilih=upload_sp&id=<?php echo $data['idarsip_sp_detail'] ?>">Upload PDF</a></td>
<td align="center" align="center" class="isitabel"> <a href="?hal=page_arsip&pilih=edit_sp&id=<?php echo  $data['idarsip_sp_detail']; ?> " target="_blank"><img src="images/new/edit.png"  title="Edit" /></a></td>
<td align="center" align="center" class="isitabel"><a href="arsip/sp/sp_delete.php?id=<?php echo  $data['idarsip_sp_detail']; ?>"><img src="images/new/delete.png" title="Delete SP" onclick="javascript:return confirm('Anda Yakin Hapus Data Penting ini? ?')"/></a> </td>
