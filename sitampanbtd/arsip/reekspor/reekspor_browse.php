...
<html>
    ...
    <body>
                ...
                <?php // yang belum koneksi database diabaikan aja dulu file ini
                    ...
                    ?>
                <form method="post" action=<?php echo "index.php?hal=set_reeks_browse"; ?> >
                <table> 
                ...
                <td align="center" class="isitabel"><a href="?hal=set_reeks_input&id=<?php echo $data['idbcf15']; ?>"><img src="images/new/update.png"/></a> </td>
                </tr>
                <?php
                };
                ?>
