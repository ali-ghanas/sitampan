...
<html>
    <head>
    <title>SITAMPAN-softcopy Konfirmasi BCF 1.5</title>
    ...
    <body>
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <table width="100%"><tr><td class="judultabel1">Pembatalan BCF 1.5 (Konfirmasi Soft Copy)</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=newpembatalan&pilihloket=new_batalsoft_que"; ?> >
                    ...
                    $reload = "index.php?hal=newpembatalan&pilihloket=new_batalsoft_que";
                    ...
                    $sql = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,konf_nondp2,konf_tglndp2,konf_nondtpp,konf_tglndtpp,konf_manualhc,konf_jwabanmanualhc,Catatan_manual_p2
                           FROM kofirmasi_p2 where   (konf_statusakhir='konf_selesai'  ) and konf_manualhc='0'   and ".$bagianWhere."   order by idbcf15 desc ";
                    ...
                    $sqltampil = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,konf_nondp2,konf_tglndp2,konf_nondtpp,konf_tglndtpp,konf_manualhc,konf_jwabanmanualhc,Catatan_manual_p2
                           FROM kofirmasi_p2 where   (konf_statusakhir='konf_selesai'  ) and konf_manualhc='0'   and ".$bagianWhere."   order by idbcf15 desc LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,konf_nondp2,konf_tglndp2,konf_nondtpp,konf_tglndtpp,konf_manualhc,konf_jwabanmanualhc,Catatan_manual_p2
                           FROM kofirmasi_p2 where   (konf_statusakhir='konf_selesai'  ) and konf_manualhc='0'   order by idbcf15 desc ";
                    $result = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,konf_nondp2,konf_tglndp2,konf_nondtpp,konf_tglndtpp,konf_manualhc,konf_jwabanmanualhc,Catatan_manual_p2
                           FROM kofirmasi_p2 where   (konf_statusakhir='konf_selesai'  ) and konf_manualhc='0'   order by idbcf15 desc  LIMIT $limit,$rpp" ;
        ...
        <br/>
                    ...
                    <table class="data" width="100%">
                            ...
                            <th class="judultabel"  colspan="2">Konfirmasi SoftCopy</th>
                            <th class="judultabel"  colspan="2">Jawaban Konf SoftCOpy</th>
                            ...
                            <tr>
                                ...
                                <th class="judultabel" >Tanggal Kirim</th>
                                <th class="judultabel" >User</th>
                                <th class="judultabel" >Tanggal Balas</th>
                    ...
                    <td class="isitabel"><?php echo  $data['nm_usertpp'];  ?></td>
                    <td class="isitabel"><?php echo  $data['konf_tglkonftpp']; ?></td>
                   
                    <td class="isitabel"><?php echo  $data['nm_userp2'];  ?></td>
                    <td class="isitabel"><?php echo  $data['konf_tglkonfp2']; ?></td>
                    <td class="isitabel"><?php echo  $status ?></td>
                    <td class="isitabel"><a href="?hal=newpembatalan&pilihloket=new_viewbatal&id=<?php echo $data['idbcf15'] ?>">Lihat</a></td>
                    <td class="isitabel"><a href="?hal=newpembatalan&pilihloket=new_editbatal&id=<?php echo $data['idbcf15'] ?>">Edit</a></td>
                    <td class="isitabel"><a href="report/kartukendalikonfirmasi.php?id=<?php echo $data['idbcf15'] ?>" target="_blank">K.Kendali</a></td>
