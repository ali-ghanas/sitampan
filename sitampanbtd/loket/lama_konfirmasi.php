...
<html>
    ...
    <body>
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <table width="100%"><tr><td class="judultabel1">Nota Dinas Konfirmasi BCF 1.5</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=pagekonfirmasi"; ?> >
                    <table>
                        <tr>
                            <td><a href="?hal=pagekonfirmasi">Nota Dinas Konfirmasi Ke P2</a></td><td>|</td><td><a href="?hal=ndreekspormanifest">Nota Dinas Penyampaian Hasil Pencacahan Ke Manifest</a></td>
                        </tr>
                        <tr>
                    ...
                    $reload = "index.php?hal=pagekonfirmasi";
                    ...
                    $sql = "SELECT idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,Pemohon,NoKepStatus_Akhr
                        FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and recordstatus='2' and setujubatal='2' and ".$bagianWhere."   order by bcf15.idbcf15 desc ";
                    ...
                    $sqltampil = "SELECT idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,Pemohon,NoKepStatus_Akhr
                        FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and recordstatus='2' and setujubatal='2' and ".$bagianWhere."  order by bcf15.idbcf15 desc  LIMIT $limit,$rpp";
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,Pemohon,NoKepStatus_Akhr
                        FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and recordstatus='2' and setujubatal='2'  order by idbcf15 desc  LIMIT $limit,$rpp" ;
        ...
        <br/>
                    ...
                    <td align="center" class="isitabel"> <?php if ($data['SuratBatalNo']=='') {echo "<a href='?hal=ndkonfirmasip2tpp&id=$data[idbcf15]' target='_self'><img src=\"images/new/update.png\" ></img></a> ";}   else {echo "<a href='?hal=ndkonfirmasip2tpp&id=$data[idbcf15]' target='_self'><img src=\"images/new/update.png\" ></img></a>"; } ?>
                    </td>
                    <td align="center" class="isitabel"><?php if ($data['ndkonfirmasino']=='') {echo "-";}   else {echo "<a href='?hal=ndkonfirmasip2tppok&id=$data[idbcf15]&nond=$data[ndkonfirmasino]&tahun=$data[tahun]' target='_self'><img src=\"images/new/view.png\" ></img></a>"; } ?> </td>
