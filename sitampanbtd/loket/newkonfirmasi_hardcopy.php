...
<html>
    ...
    <body>
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <table width="100%"><tr><td class="judultabel1">Konfirmasi Yang Memerlukan Hardcopy Konfimasi Pembatalan BCF 1.5</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=newkonfirmasi&pilihloket=new_terkirim"; ?> >
                    ...
                    $reload = "index.php?hal=newkonfirmasi&pilihloket=new_terkirim";

                    // data mentah 
                    $sql = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam
                           FROM kofirmasi_p2 where   (konf_statusakhir='konf_hardcopy'  ) and konf_manualhc='0' and ".$bagianWhere."   order by idbcf15 desc ";
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam
                           FROM kofirmasi_p2 where   (konf_statusakhir='konf_hardcopy'  ) and konf_manualhc='0' and ".$bagianWhere."   order by idbcf15 desc LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam
                           FROM kofirmasi_p2 where   (konf_statusakhir='konf_hardcopy'  ) and konf_manualhc='0' order by idbcf15 desc ";
                    $result = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam
                           FROM kofirmasi_p2 where   (konf_statusakhir='konf_hardcopy'  ) and konf_manualhc='0' order by idbcf15 desc  LIMIT $limit,$rpp" ;
        ...
        <br/>
                    ...
                    <table class="data" width="100%">
                            ...
                            <th class="judultabel"  colspan="7">Respon Konfirmasi</th>
                    ...
                    <td class="isitabel"><?php echo  $data['konf_bc11psubpos']; ?></td>
                    ...
                    <td class="isitabel"><a href="?hal=newkonfirmasi&pilihloket=new_hardcopy_kirim&id=<?php echo $data['idbcf15'] ?>">Kirim </a></td>
