...
if(isset($_POST['editsubmit2'])) // jika tombol editsubmit ditekan
	{               
		...
		echo "<script type='text/javascript'>window.location='index.php?hal=loketeditbcf15&id=$idbcf15'</script>";
        }
        else 
	{
	...
	$data = mysql_fetch_array($query);
        ...
        <form method="post" id="editcon" name="editcon" action="?hal=loketedit_cont">
