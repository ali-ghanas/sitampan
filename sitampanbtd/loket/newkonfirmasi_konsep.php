...
<html>
    ...
    <body>
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <table width="100%"><tr><td class="judultabel1">Daftar Konsep Konfirmasi BCF 1.5</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=newkonfirmasi&pilihloket=new_konsep"; ?> >
                    <table class="data isitabel">
                        <tr bgcolor="#f5e5e7">
                            <td colspan="2"><p><b>Daftar Konsep merupakan konsep konfirmasi BCF 1.5 by sistem aplikasi yang belum dikirim ke P2, sifatnya masih bisa diubah oleh Staf Seksi Tempat Penimbunan dan harus segera dikirim ke P2. modul ini menyimpan daftar konsep konfirmasi yang diinput apabila terdapat pengajuan dokumen konfirmasi yang telah melewati jam kerja.</b></p></td>
                        </tr>
                    ...
                    $reload = "index.php?hal=newkonfirmasi&pilihloket=new_konsep";
                    ...
                    $sql = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir
                        FROM kofirmasi_p2 where  konf_statusakhir='konsep' and ".$bagianWhere."   order by idbcf15 desc ";
                    ...
                    $sqltampil = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir
                        FROM kofirmasi_p2 where  konf_statusakhir='konsep' and ".$bagianWhere."   order by idbcf15 desc LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir
                       FROM kofirmasi_p2 where  konf_statusakhir='konsep' order by idbcf15 desc ";
                    $result = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir
                       FROM kofirmasi_p2 where  konf_statusakhir='konsep' order by idbcf15 desc  LIMIT $limit,$rpp" ;
        ...
        <br/>
                    ...
                    <table class="data" width="100%">
                            ...
                            <th class="judultabel" >Tgl Konsep</th>
                            <th class="judultabel" >Ket</th>
                            <th class="judultabel" >Kirim Lagi</th>
                    ...
                    <td class="isitabel"><a href="?hal=newkonfirmasi&pilihloket=new_kirimtpp&id=<?php echo $data['idbcf15'] ?>">Kirim</a></td>
