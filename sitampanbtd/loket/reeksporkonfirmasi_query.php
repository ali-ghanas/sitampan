...
<html>
    ...
    <body>
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <table width="100%"><tr><td class="judultabel1">Monitoring Penyampaian Nota Dinas Reekspor Yang masih belum dibatalkan BCF 1.5</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=ndreekspormanifestque"; ?> >
                    <table>
                        <tr>
                            <td><a href="?hal=pagekonfirmasi">Nota Dinas Konfirmasi Ke P2</a></td><td>|</td><td><a href="?hal=ndreekspormanifest">Nota Dinas Penyampaian Hasil Pencacahan Ke Manifest</a></td> <td>|</td><td><a href="?hal=ndreekspormanifestque">Monitoring Reekspor</a></td> 
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <table class="isitabel" width="100%" bgcolor="#9ec2e5">
                                    <tr>
                    ...
                    $reload = "index.php?hal=ndreekspormanifestque";

                    // data mentah 
                    $sql = "SELECT idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,Pemohon,NoKepStatus_Akhr,nondmanifestreekspor,tglndmanifestreekspor,jawabanndreekspor,jawabanndreeksporno,jawabanndreeksportgl,CacahNo,CacahDate,reekspor
                        FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and recordstatus='2' and reekspor='1' and setujubatal='2' and ".$bagianWhere."   order by bcf15.idbcf15 desc ";
                    ...
                    $sqltampil = "SELECT idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,Pemohon,NoKepStatus_Akhr,nondmanifestreekspor,tglndmanifestreekspor,jawabanndreekspor,jawabanndreeksporno,jawabanndreeksportgl,CacahNo,CacahDate,reekspor
                        FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and recordstatus='2' and reekspor='1' and setujubatal='2' and ".$bagianWhere."  order by bcf15.idbcf15 desc  LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,Pemohon,NoKepStatus_Akhr,nondmanifestreekspor,tglndmanifestreekspor,jawabanndreekspor,jawabanndreeksporno,jawabanndreeksportgl,CacahNo,CacahDate,reekspor
                        FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and recordstatus='2' and reekspor='1' and setujubatal='2' order by idbcf15 desc ";
                    $result = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,Pemohon,NoKepStatus_Akhr,nondmanifestreekspor,tglndmanifestreekspor,jawabanndreekspor,jawabanndreeksporno,jawabanndreeksportgl,CacahNo,CacahDate,reekspor
                        FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and recordstatus='2' and reekspor='1' and setujubatal='2'  order by idbcf15 desc  LIMIT $limit,$rpp" ;
        ...
        <br/>
                    ...
                    <table class="data" width="100%">
                            ...
                            <th class="judultabel" colspan="2">ND Manifest</th>
                            <th class="judultabel" colspan="2">ND Penimbunan</th>
                            <th class="judultabel" colspan="2">Surat Permohonan</th>
                            
                            <th class="judultabel" rowspan="2">Status Container</th>
                            <th class="judultabel" rowspan="2">Lama Timbun di TPP</th>
                           <th class="judultabel" rowspan="2">Ket</th>
                           <th class="judultabel" rowspan="2">Input</th>
                    ...
                    <td class="isitabel"><?php echo  $data['nondmanifestreekspor']; ?></td>
                    <td class="isitabel"><?php echo  tglindo($data['tglndmanifestreekspor']); ?></td>
                    <td class="isitabel"><?php echo  $data['jawabanndreeksporno']; ?></td>
                    <td class="isitabel"><?php echo  tglindo($data['jawabanndreeksportgl']); ?></td>
                    ...
                    <td align="center" class="isitabel"> <?php if ($data['SuratBatalNo']=='') {echo "<a href='?hal=ndreekspormanifestinput&id=$data[idbcf15]' target='_self'><img src=\"images/new/update.png\" ></img></a> ";}   else {echo "<a href='?hal=ndreekspormanifestinput&id=$data[idbcf15]' target='_self'><img src=\"images/new/update.png\" ></img></a>"; } ?>
                    </td>
