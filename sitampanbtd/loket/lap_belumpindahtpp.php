   ...
   <script type="text/javascript">
    ...
    <body>
                    ...
                    */
                    ...
                    <form method="post" action=<?php echo "index.php?hal=lap_belumpindahtpp"; ?> >
                    <table border="0">
                    ...
                    if (($mode=='cari')) {
                                        ...
                                        if (isset($_POST['Bcf15tgl']))
                                        {
                                           ...
                                           {
                                                $bagianWhere .= "bcf15view.bcf15tgl between '$bcf15tgl1' and '$bcf15tgl2'";
                                           }
                                           else
                                           {
                                                $bagianWhere .= " AND bcf15view.bcf15tgl between '$bcf15tgl1' and '$bcf15tgl2'";
                                           }
                                        }
                    ...
                    $reload = "index.php?hal=lap_belumpindahtpp";

                    // data mentah 
                    $sql = "SELECT * FROM bcf15view,tpp,typecode  where bcf15view.idtypecode=typecode.idtypecode and  bcf15view.idtpp=tpp.idtpp and recordstatus='2' and masuk='2'  and ".$bagianWhere."   order by bcf15view.idbcf15 desc ";
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15view,tpp,typecode  where bcf15view.idtypecode=typecode.idtypecode and bcf15view.idtpp=tpp.idtpp and  recordstatus='2' and masuk='2' and ".$bagianWhere."  order by bcf15view.idbcf15 desc  LIMIT $limit,$rpp";
         ...
         <?php 
                    ...
                    ?>
        <br/>
                                    <form name="form1" method="get" action="report/export/lap_excel_loket_belummasuk.php">
