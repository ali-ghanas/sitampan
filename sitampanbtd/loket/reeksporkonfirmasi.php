...
<html>
    ...
    <body>
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <table width="100%"><tr><td class="judultabel1">Nota Dinas Penyampaian Hasil Pencacahan</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=ndreekspormanifest"; ?> >
                    <table>
                        <tr>
                    ...
                    $reload = "index.php?hal=ndreekspormanifest";
