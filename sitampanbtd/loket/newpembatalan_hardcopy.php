...
<html>
    ...
    <body>
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <table width="100%"><tr><td class="judultabel1">Konfirmasi BCF 1.5 yang dapat segera dibatalkan BCF 1.5</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=newpembatalan&pilihloket=new_batalhard"; ?> >
                    ...
                    $sqltampil = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,konf_nondp2,konf_tglndp2,konf_nondtpp,konf_tglndtpp,konf_manualhc,konf_jwabanmanualhc,Catatan_manual_p2
                           FROM kofirmasi_p2 where   (konf_statusakhir='konf_hardcopy'  ) and konf_manualhc='1' and konf_jwabanmanualhc='1'   and ".$bagianWhere."   order by idbcf15 desc LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,konf_nondp2,konf_tglndp2,konf_nondtpp,konf_tglndtpp,konf_manualhc,konf_jwabanmanualhc,Catatan_manual_p2
                           FROM kofirmasi_p2 where   (konf_statusakhir='konf_hardcopy'  ) and konf_manualhc='1' and konf_jwabanmanualhc='1'  order by idbcf15 desc ";
                    $result = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,konf_nondp2,konf_tglndp2,konf_nondtpp,konf_tglndtpp,konf_manualhc,konf_jwabanmanualhc,Catatan_manual_p2
                           FROM kofirmasi_p2 where   (konf_statusakhir='konf_hardcopy'  ) and konf_manualhc='1' and konf_jwabanmanualhc='1'  order by idbcf15 desc  LIMIT $limit,$rpp" ;
        ...
        <br/>
                    ...
                    <table class="data" width="100%">
                            ...
                            <th class="judultabel"  colspan="2">Konfirmasi Manual</th>
                            <th class="judultabel"  colspan="2">Jawaban Konf Manual</th>
                            <th class="judultabel" rowspan="2">Catatan Manual P2</th>
                            ...
                            <tr>
                                ...
                                <th class="judultabel" >Nomor</th>
                                <th class="judultabel" >Tanggal</th>
                                <th class="judultabel" >Batalkan</th>
                                <th class="judultabel" >Konf Kembali</th>
                    ...
                    <td class="isitabel"><a style="color:red;font-weight: bold;" href="?hal=newpembatalan&pilihloket=new_batalhard_proses&id=<?php echo $data['idbcf15'] ?>"><?php echo  $data['konf_bcf15no']; ?></a></td>
                    ...
                    <td class="isitabel"><?php echo  $data['konf_nondp2'];  ?></td>
                    <td class="isitabel"><?php echo  $data['konf_tglndp2']; ?></td>
                    <td class="isitabel"><?php echo  $data['Catatan_manual_p2'] ?></td>
                    <td class="isitabel"><a style="color:red;font-weight: bold;" href="?hal=newpembatalan&pilihloket=new_batalhard_proses&id=<?php echo $data['idbcf15'] ?>">BatalKan</a></td>
                    <td class="isitabel"><a style="color:red;font-weight: bold;" href="?hal=newpembatalan&pilihloket=new_batalhardkonf_proses&id=<?php echo $data['idbcf15'] ?>">Konf Kembali</a></td>
