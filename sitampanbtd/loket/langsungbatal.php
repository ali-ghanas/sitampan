...
<html>
    ...
    <body>
                   ...
                   <?php // yang belum koneksi database diabaikan aja dulu file ini
                    ...
                    ?>
                    <form method="post" action=<?php echo "index.php?hal=pagebatal&pilihloket=tanpakonf"; ?> >
                    <table border="0">
                    ...
                    $reload = "index.php?hal=pagebatal&pilihloket=tanpakonf";

                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp where bcf15.idtpp=tpp.idtpp and ((bcf15no LIKE '%$katakunci%') 
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' ((jalur='1' or  jalur='2' or jalur='3' or jalur='4' or jalur='5') and recordstatuskonf='0' and batal='1' and perlukonf='0' and setujubatal='2'  ) order by idbcf15 desc ";
                    ...
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and ((jalur='1' or  jalur='2' or jalur='3' or jalur='4' or jalur='5') and recordstatuskonf='0' and batal='1' and perlukonf='0' and setujubatal='2'  ) order by idbcf15 desc LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp where bcf15.idtpp=tpp.idtpp and ((jalur='1' or  jalur='2' or jalur='3' or jalur='4' or jalur='5') and recordstatuskonf='0' and batal='1' and perlukonf='0' and setujubatal='2'  ) order by idbcf15 desc ";
                    $result = mysql_query($sql);
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15,tpp where bcf15.idtpp=tpp.idtpp and ((jalur='1' or  jalur='2' or jalur='3' or jalur='4' or jalur='5') and recordstatuskonf='0' and batal='1' and perlukonf='0' and setujubatal='2'  ) order by idbcf15 desc LIMIT $limit,$rpp" ;
                    ...
                    <td align="center" class="isitabel" title='Input ND Konfirmasi'> <?php if ($data['NoKepStatus_Akhr']=='') {echo "<a href='?hal=suratbataltpp&id=$data[idbcf15]' target='_blank'><img src='images/new/edit.png' title='Input ND Konfirmasi'/></a> ";}   else {echo ''; } ?> 
                    </td>
