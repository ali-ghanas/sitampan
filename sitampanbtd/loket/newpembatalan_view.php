            ...
            <tr valign="top">
                <td colspan="4">
                    <table class="data isitabel" bgcolor="#eeefff">
                        <tr>
                                <td colspan="6" align="center" bgcolor="#95b0cb">
                                    <font size="3">Pembatalan BCF 1.5</font>
                                </td>
                         </tr>
                        <tr class="isitabel">
                            <td>
                                <font color="#000">No Surat Persetujuan</font>
                            </td>
                            <td>
                                <font color="#000">:</font>
                            </td>
                            <td>
                               <?php echo $data1['SetujuBatalNo'] ?> / <?php echo $data1['SetujuBatalDate'] ?>
                            </td>
                        </tr>
                        <tr class="isitabel">
                            <td>
                                <font color="#000">Atas Persetujuan</font>
                            </td>
                            <td>
                                <font color="#000">:</font>
                            </td>
                            <td>
                               <?php echo $data1['idseksisetujubatal'] ?> 
                            </td>
                        </tr>
                        <tr class="isitabel">
                            <td>
                            ...
                            <td>
                                <?php echo $data['nmrekam_batal'] ?> / <?php echo $data['niprekam_batal'] ?>
                            </td>
                        </tr>
                        <tr class="isitabel">
                            <td>
                                <font color="#000">Tgl rekam Batal</font>
                            </td>
                            <td>
                                <font color="#000">:</font>
                            </td>
                            <td>
                                <?php echo $data['tglrekam_batal'] ?> 
                            </td>
                        </tr>
                        <tr class="isitabel">
                            <td>
                                <font color="#000">IP rekam Batal</font>
                            </td>
                            <td>
                                <font color="#000">:</font>
                            </td>
                            <td>
                                <?php echo $data['iprekam_batal'] ?> 
                            </td>
                        </tr>
