...
<!--        <link rel="stylesheet" type="text/css" href="themes/main.css" />-->
    ...
    <body>
                   ...
                   <?php // yang belum koneksi database diabaikan aja dulu file ini
                    ...
                    ?>
                    <form method="post" action=<?php echo "index.php?hal=loketpecahpos"; ?> >
                    <table> 
                    ...
                    $reload = "index.php?hal=loketpecahpos";

                    // data mentah 
                    $sql = "SELECT * FROM bcf15 where  setujubatal='2' and recordstatus='2' and ((bcf15no LIKE '%$katakunci%') 
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15 where  setujubatal='2' and recordstatus='2' and ((bcf15no LIKE '%$katakunci%') 
                    ...
                    // data mentah 
                    $sql = "SELECT * FROM bcf15 where setujubatal='2' and recordstatus='2'  order by bcf15tgl desc ";
                    $result = mysql_query($sql);
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15 where setujubatal='2' and recordstatus='2'  order by bcf15tgl desc LIMIT $limit,$rpp" ;
                    ...
                    <table class="data" >
                            ...
                            <th class="judultabel">Tgl BC 1.1</th>
                            <th class="judultabel">Pos</th>
                            <th class="judultabel">SubPos</th>
                    ...
                    <td class="isitabel"><?php echo  $data['bc11subpos']; ?></td>
                   ...
                   <td align="center" class="isitabel"><a href="?hal=loketin_pecahpos&id=<?php echo $data[idbcf15]?>" target='_new'>Pecah</a> </td>
                    
                    <td align="center" class="isitabel"><a href="?hal=loketeditbcf15&id=<?php echo $data[idbcf15]?>" target='_new'>Edit</a> </td>
                    </tr>
