...
<html>
    ...
    <body>
                   ...
                   <?php // yang belum koneksi database diabaikan aja dulu file ini
                    ...
                    ?>
                    <form method="post" action=<?php echo "index.php?hal=pagekonfirmasi&pilihloket=edit_konf"; ?> >
                    <table border="0">
                    ...
                    $reload = "index.php?hal=pagekonfirmasi&pilihloket=edit_konf";

                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp  where bcf15.idtpp=tpp.idtpp and ((bcf15no LIKE '%$katakunci%') 
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and recordstatus='2' and recordstatuskonf='2' and setujubatal='2' order by tahun desc ";
                    ...
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and recordstatus='2' and recordstatuskonf='2' and setujubatal='2' order by tahun desc LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp where bcf15.idtpp=tpp.idtpp and recordstatus='2' and recordstatus='2' and recordstatuskonf='2' and setujubatal='2' order by tahun desc ";
                    $result = mysql_query($sql);
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15,tpp  where bcf15.idtpp=tpp.idtpp and recordstatus='2' and recordstatus='2' and recordstatuskonf='2' and setujubatal='2'  order by tahun desc LIMIT $limit,$rpp" ;
                    ...
                    <table class="data" width="100%">
                            ...
                            <th class="judultabel" >Edit ND</th>
                            </tr>
                    ...
                    <td align="center" class="isitabel" title='Edit ND Konfirmasi'> <?php if ($data['NoKepStatus_Akhr']=='') {echo "<a href='?hal=ndkonfirmasip2tpp&id=$data[idbcf15]' ><img src='images/new/edit.png' title='Input ND Konfirmasi'/></a> ";}   else {echo ''; } ?> 
                    </td>
