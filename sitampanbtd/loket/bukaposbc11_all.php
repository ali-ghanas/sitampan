   ...
   <script type="text/javascript">
    ...
    <body>
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <table width="100%"><tr><td class="judultabel1">Daftar Pembukaan POS BC 1.1 (APP CEISA) Seluruh Nota Dinas Yang Dikirim Ke Manifest</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=bukaposbc11all"; ?> >
                    <table border="0">
                        <tr>
                    ...
                    $reload = "index.php?hal=bukaposbc11all";

                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and recordstatus='2' and bukaposbc11ceisa='1'  and ".$bagianWhere."   order by nobukaposbc11ceisa desc ";
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and bcf15.idtpp=tpp.idtpp and  recordstatus='2' and bukaposbc11ceisa='1' and  ".$bagianWhere."  order by nobukaposbc11ceisa desc  LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode  and bcf15.idtpp=tpp.idtpp and recordstatus='2' and bukaposbc11ceisa='1'  order by nobukaposbc11ceisa desc ";
                    $result = mysql_query($sql);
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15,tpp,typecode where bcf15.idtypecode=typecode.idtypecode  and bcf15.idtpp=tpp.idtpp and recordstatus='2' and bukaposbc11ceisa='1'  order by nobukaposbc11ceisa desc  LIMIT $limit,$rpp" ;
         ...
         <?php 
                    ...
                    ?>
        <br/>
                                    <form name="form1" method="get" action="report/daftarbukaposbc11_all.php">
                    ...
                    while($data = mysql_fetch_array($tampil)){
                        ...
                        if($data['Dokumen2Code']=='1'){$Dokumen2Code='SPPB';}elseif($data['Dokumen2Code']==''){$Dokumen2Code='';} elseif($data['Dokumen2Code']=='9'){$Dokumen2Code='BA MUSNAH';}elseif($data['Dokumen2Code']=='11'){$Dokumen2Code='ND Manifest';} elseif($data['Dokumen2Code']=='27'){$Dokumen2Code='Persetujuan Reekspor';}
