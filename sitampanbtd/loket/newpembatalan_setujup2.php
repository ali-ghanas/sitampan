...
<html>
    ...
    <body>
                    ...
                    */
                    ...
                    <form method="post" action=<?php echo "index.php?hal=newpembatalan&pilihloket=new_batalsoft"; ?> >
                    ...
                    $reload = "index.php?hal=newpembatalan&pilihloket=new_batalsoft";
                    ...
                    $sql = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,konf_nondp2,konf_tglndp2,konf_nondtpp,konf_tglndtpp,konf_manualhc,konf_jwabanmanualhc
                           FROM kofirmasi_p2 where   (konf_statusakhir='konf_jawabok'  ) and konf_manualhc='0'   and ".$bagianWhere."   order by idbcf15 desc ";
                    ...
                    $sqltampil = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,konf_nondp2,konf_tglndp2,konf_nondtpp,konf_tglndtpp,konf_manualhc,konf_jwabanmanualhc
                           FROM kofirmasi_p2 where   (konf_statusakhir='konf_jawabok'  ) and konf_manualhc='0'   and ".$bagianWhere."   order by idbcf15 desc LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,konf_nondp2,konf_tglndp2,konf_nondtpp,konf_tglndtpp,konf_manualhc,konf_jwabanmanualhc
                           FROM kofirmasi_p2 where   (konf_statusakhir='konf_jawabok'  ) and konf_manualhc='0'   order by idbcf15 desc ";
                    $result = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,konf_nondp2,konf_tglndp2,konf_nondtpp,konf_tglndtpp,konf_manualhc,konf_jwabanmanualhc
                           FROM kofirmasi_p2 where   (konf_statusakhir='konf_jawabok'  ) and konf_manualhc='0'   order by idbcf15 desc  LIMIT $limit,$rpp" ;
        ...
        <br/>
                    ...
                    <table class="data" width="100%">
                            ...
                            <th class="judultabel"  colspan="4">Konfirmasi Manual</th>
                            <th class="judultabel" rowspan="2">Status</th>
                            <th class="judultabel" rowspan="2">Action</th>
                            <?php 
                            if($_SESSION['level']=='admin'){echo "<th class='judultabel' rowspan='2'>Reset</th>";}
                                else {echo "";}
                            ?>
                            ...
                            <tr>
                                ...
                                <th class="judultabel" colspan="2">ND P2</th>
                    ...
                    <td class="isitabel"><a style="color:red;font-weight: bold;" href="?hal=newpembatalan&pilihloket=new_batalsoft_proses&id=<?php echo $data['idbcf15'] ?>"><?php echo  $data['konf_bcf15no']; ?></a></td>
                    ...
                    <td class="isitabel"><?php echo $manualtpp; ?></td>
                    <td class="isitabel"><?php echo  $data['konf_nondtpp']; echo "/" ;echo  $data['konf_tglndtpp']; ?></td>
                    <td class="isitabel"><?php echo $manualp2; ?></td>
                    <td class="isitabel"><?php echo  $data['konf_nondp2']; echo "/" ;echo  $data['konf_tglndp2']; ?></td>
                    <td class="isitabel"><?php echo  $status; ?></td>
                    <td class="isitabel"><a style="color:red;" href="?hal=newpembatalan&pilihloket=new_batalsoft_proses&id=<?php echo $data['idbcf15'] ?>"><b>Batalkan</b></a></td>
                     <?php 
                            if($_SESSION['level']=='admin'){
                                
                            ?>
                    <td class="isitabel"><a href="loket/newpembatalan_resetkonfirmasi.php?id=<?php echo $data['idbcf15'] ?>"  onclick="javascript:return confirm('Lanjutkan Mereset konfirmasi ini??')" >Reset</a></td>
