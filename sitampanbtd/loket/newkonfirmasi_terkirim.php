...
<html>
    <head>
    <title>SITAMPAN-Konsep BCF 1.5 Yang dikonfirmasi ke P2</title>
    ...
    <body>
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <table width="100%"><tr><td class="judultabel1">Konfirmasi BCF 1.5 Yang Terkirim</td></tr></table>
                    ...
                    // data mentah 
                    $sql = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir
                        FROM kofirmasi_p2 where   (konf_statusakhir='konf_system' or  konf_statusakhir='konf_hardcopy' or  konf_statusakhir='konf_jawabok' ) and ".$bagianWhere."   order by idbcf15 desc ";
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir
                        FROM kofirmasi_p2 where  ( konf_statusakhir='konf_system' or  konf_statusakhir='konf_hardcopy' or  konf_statusakhir='konf_jawabok' ) and ".$bagianWhere."   order by idbcf15 desc LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir
                       FROM kofirmasi_p2 where   (konf_statusakhir='konf_system' or  konf_statusakhir='konf_hardcopy' or  konf_statusakhir='konf_jawabok' ) order by idbcf15 desc ";
                    $result = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir
                       FROM kofirmasi_p2 where  ( konf_statusakhir='konf_system' or  konf_statusakhir='konf_hardcopy' or  konf_statusakhir='konf_jawabok' ) order by idbcf15 desc  LIMIT $limit,$rpp" ;
        ...
        <br/>
                    ...
                    <table class="data" width="100%">
                            ...
                            <th class="judultabel" >BC 1.1</th>
                            <th class="judultabel" >Pos</th>
                            <th class="judultabel" >Tgl Kirim</th>
                            <th class="judultabel" >Ket</th>
                            <th class="judultabel" >Kirim</th>
                            <th class="judultabel" >Reset Konfirmasi</th>
                    ...
                    <td class="isitabel">Nama :<?php echo  $data['nm_usertpp']; ?><br/> Nip : <?php echo  $data['nip_usertpp']; ?> <br/>IP :<?php echo  $data['ip_usertpp']; ?> </td>
                    <td class="isitabel"><a href="?hal=newkonfirmasi&pilihloket=new_viewkonf&id=<?php echo $data['idbcf15'] ?>">Lihat</a></td>
                    <td class="isitabel"><a href="loket/newkonfirmasi_resetkonfirmasi.php?id=<?php echo $data['idbcf15'] ?>"  onclick="javascript:return confirm('Lanjutkan Mereset konfirmasi ini??')" >Reset</a></td>
