...
<html>
    ...
    <body>
                   ...
                   <?php // yang belum koneksi database diabaikan aja dulu file ini
                    ...
                    ?>
                    <form method="post" action=<?php echo "index.php?hal=pagebatal&pilihloket=newp2"; ?> >
                    <table border="0">
                    ...
                    $reload = "index.php?hal=pagebatal&pilihloket=newp2";

                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp  where bcf15.idtpp=tpp.idtpp and ((bcf15no LIKE '%$katakunci%') 
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and recordstatus='2' and (recordstatuskonf='3' or recordstatuskonf='1' or recordstatuskonf='2') and setujubatal='2' order by tahun desc ";
                    ...
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and recordstatus='2' and (recordstatuskonf='3' or recordstatuskonf='1' or recordstatuskonf='2') and setujubatal='2' order by tahun desc LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp where bcf15.idtpp=tpp.idtpp and recordstatus='2' and recordstatus='2' and (recordstatuskonf='3' or recordstatuskonf='2' or recordstatuskonf='1') and setujubatal='2' order by tahun desc ";
                    $result = mysql_query($sql);
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15,tpp  where bcf15.idtpp=tpp.idtpp and recordstatus='2' and recordstatus='2' and (recordstatuskonf='3' or recordstatuskonf='2' or recordstatuskonf='1' ) and setujubatal='2'  order by tahun desc LIMIT $limit,$rpp" ;
                    ...
                    <table class="data" width="100%">
                            ...
                            <th class="judultabel" >Status Konfirmasi P2</th>
                    ...
                    <td align="center" class="isitabel"> <?php if ($data['jawabanndkonfirmasi']=='1') {echo "<font style='background-color:green' color='#fff'>proses lanjut</font>";} elseif ($data['jawabanndkonfirmasi']=='2') {echo "<font style='background-color:red' color='white'>Pending</font>";}  ?></td>
