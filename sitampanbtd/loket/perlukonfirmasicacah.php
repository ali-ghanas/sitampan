...
<html>
    ...
    <body>
                   ...
                   <?php // yang belum koneksi database diabaikan aja dulu file ini
                    ...
                    ?>
                    <form method="post" action=<?php echo "index.php?hal=pageloket&pilihloket=newp2"; ?> >
                    <table border="0">
                    ...
                    $reload = "index.php?hal=pageloket&pilihloket=newp2";

                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp  where bcf15.idtpp=tpp.idtpp and ((bcf15no LIKE '%$katakunci%') 
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and recordstatus='2' and perlukonf='1'  and recordstatuskonf='0' order by tahun desc ";
                    ...
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and recordstatus='2' and perlukonf='1' and recordstatuskonf='0' order by tahun desc LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp where bcf15.idtpp=tpp.idtpp and recordstatus='2' and perlukonf='1' and recordstatuskonf='0'  order by tahun desc ";
                    $result = mysql_query($sql);
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15,tpp  where bcf15.idtpp=tpp.idtpp and recordstatus='2' and perlukonf='1' and recordstatuskonf='0'  order by tahun desc LIMIT $limit,$rpp" ;
                    ...
                    <td class="isitabel" align="center"><?php if($data['bamasukno']=='') {echo '';} else {echo  "$selisih Hari" ;} ?></td>
                    <td align="center" class="isitabel" title='Input ND Konfirmasi'> <?php if ($data['NoKepStatus_Akhr']=='') {echo "<a href='?hal=ndkonfirmasip2tpp&id=$data[idbcf15]' ><img src='images/new/edit.png' title='Input ND Konfirmasi'/></a> ";}   else {echo ''; } ?> 
                    </td>
