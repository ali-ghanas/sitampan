...
<html>
    ...
    <body>
                   ...
                   <?php // yang belum koneksi database diabaikan aja dulu file ini
                    ...
                    ?>
                    <form method="post" action=<?php echo "index.php?hal=pagebatal&pilihloket=dafbatal"; ?> >
                    <table border="0">
                    ...
                    $reload = "index.php?hal=pagebatal&pilihloket=dafbatal";

                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp  where bcf15.idtpp=tpp.idtpp and ((bcf15no LIKE '%$katakunci%') 
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and recordstatus='2' and Batal='1'  and setujubatal='1'order by tahun desc ";
                    ...
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and recordstatus='2' and Batal='1'  and setujubatal='1'order by tahun desc LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp where bcf15.idtpp=tpp.idtpp and recordstatus='2' and recordstatus='2' and Batal='1'  and setujubatal='1' order by tahun desc ";
                    $result = mysql_query($sql);
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15,tpp where bcf15.idtpp=tpp.idtpp and recordstatus='2' and Batal='1'  and setujubatal='1' order by tahun desc LIMIT $limit,$rpp" ;
                    ...
                    <table class="data" width="100%">
                            ...
                            <th class="judultabel" colspan="2">Surat Persetujuan Batal BCF 1.5</th>
                    ...
                    <td align="center" class="isitabel"> <a href="?hal=suratbataltpp&id=<?php echo  $data['idbcf15']; ?>" target="_blank" ><img src="images/new/update.png" title="Detail Pembatalan" /></a></td> 
