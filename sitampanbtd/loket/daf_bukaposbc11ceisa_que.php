...
<!--        <link rel="stylesheet" type="text/css" href="themes/main.css" />-->
    ...
    <body>
                   ...
                   <?php // yang belum koneksi database diabaikan aja dulu file ini
                    ...
                    FROM bcf15,bukaposbc11 where bcf15.idbcf15=bukaposbc11.idbcf15 and recordstatus='2' and  setujubatal='2' and bukaposbc11ceisa='1' and  ".$bagianWhere." order by tahun,bcf15no asc  LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "select bcf15.idbcf15,bcf15.bcf15no,bcf15.bcf15tgl,bcf15.tahun,blno,consignee,notify,bc11no,bc11tgl,bc11pos,bc11subpos,idtps,bcf15.idtpp,Dokumen2Code,Dokumen2No,Dokumen2Date,jawaban_bukaposbc11,jawaban_bukaposbc11no,jawaban_bukaposbc11tgl,jawaban_bukaposbc11seksi,jawaban_bukaposbc11ket,bukaposbc11ceisa,nobukaposbc11ceisa,tglbukaposbc11ceisa,bamasukno,bamasukdate,NoKepStatus_Akhr,no_surat_bukapos,tgl_surat_bukapos,tgl_input,nm_petugas_rekam,nip_petugas_rekam,ip_petugas_rekam,nm_pemohon,bukaposbc11.idbcf15,nosuratpermohonanbatalbcf15,tglsuratpermohonanbatalbcf15,nm_pemohon_batal,tgl_input_permohonan,bukaposbc11.status,SuratBatalNo,SuratBatalDate,Pemohon
                    FROM bcf15,bukaposbc11 where bcf15.idbcf15=bukaposbc11.idbcf15  and setujubatal='2'  and recordstatus='2' and bukaposbc11ceisa='1' order by bcf15no desc ";
                    $result = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "select bcf15.idbcf15,bcf15.bcf15no,bcf15.bcf15tgl,bcf15.tahun,blno,consignee,notify,bc11no,bc11tgl,bc11pos,bc11subpos,idtps,bcf15.idtpp,Dokumen2Code,Dokumen2No,Dokumen2Date,jawaban_bukaposbc11,jawaban_bukaposbc11no,jawaban_bukaposbc11tgl,jawaban_bukaposbc11seksi,jawaban_bukaposbc11ket,bukaposbc11ceisa,nobukaposbc11ceisa,tglbukaposbc11ceisa,bamasukno,bamasukdate,NoKepStatus_Akhr,no_surat_bukapos,tgl_surat_bukapos,tgl_input,nm_petugas_rekam,nip_petugas_rekam,ip_petugas_rekam,nm_pemohon,bukaposbc11.idbcf15,nosuratpermohonanbatalbcf15,tglsuratpermohonanbatalbcf15,nm_pemohon_batal,tgl_input_permohonan,bukaposbc11.status,SuratBatalNo,SuratBatalDate,Pemohon
                    FROM bcf15,bukaposbc11 where bcf15.idbcf15=bukaposbc11.idbcf15  and recordstatus='2' and setujubatal='2' and bukaposbc11ceisa='1' order by bcf15no desc LIMIT $limit,$rpp" ;
                    ...
                    <table class="isitabel">
                        ...
                        <td colspan="5" align="right"><b>Halaman ke :</b>
                            ...
                            if ($nohal > 1) echo  "<a href='".$_SERVER['PHP_SELF']."?hal=bukaposbc11&page=".($nohal-1)."'>&lt;&lt; Prev</a>";
                            ...
                            else echo " <a href='".$_SERVER['PHP_SELF']."?hal=bukaposbc11&page=".$h."'>".$h."</a> ";
                            $showPage = $h;
                            }
                            }
                            ...
                            if ($nohal < $max) echo "<a href='".$_SERVER['PHP_SELF']."?hal=bukaposbc11&page=".($nohal+1)."'>Next &gt;&gt;</a>";
                            ?></td>
                      </tr>
                    ...
                    <td align="center" class="isitabel"> <a href="?hal=bukaposbc11view&id=<?php  echo $data[idbcf15]?>">Lihat</a>
                    </td>
