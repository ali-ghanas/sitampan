...
<html>
    ...
    <body>
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <table width="100%"><tr><td class="judultabel1">Browse BCF 1.5</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=newkonfirmasi&pilihloket=new_konf"; ?> >
                    ...
                    $reload = "index.php?hal=newkonfirmasi&pilihloket=new_konf";
        ...
        <br/>
                    ...
                    <td align="center" class="isitabel"><a href='?hal=newkonfirmasi&pilihloket=new_kirimtpp&id=<?php echo $data['idbcf15'] ?>' target='_self'><img src="images/new/update.png" ></img></a> 
                    </td>
