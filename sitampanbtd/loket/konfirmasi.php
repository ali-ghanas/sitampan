...
<html>
    ...
    <body>
        ...
        <table width="100%"><tr><td class="judultabel1">Nota Dinas Konfirmasi</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=konfirmasip2tpp"; ?> >
                    <table border="0">
                    ...
                    $reload = "index.php?hal=konfirmasip2tpp";

                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp  where bcf15.idtpp=tpp.idtpp and ((bcf15no LIKE '%$katakunci%') 
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and recordstatus='2' and Batal='1'  order by tahun,bcf15no desc ";
                    ...
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and recordstatus='2' and Batal='1' order by tahun,bcf15no desc LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp where bcf15.idtpp=tpp.idtpp and recordstatus='2' and Batal='1'   order by tahun,bcf15no desc ";
                    $result = mysql_query($sql);
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15,tpp where bcf15.idtpp=tpp.idtpp and recordstatus='2' and Batal='1'  order by tahun,bcf15no desc LIMIT $limit,$rpp" ;
