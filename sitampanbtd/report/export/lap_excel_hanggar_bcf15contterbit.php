...
if(isset($_GET['search'])){
    ...
    $sql = "SELECT * FROM bcf15,bcfcontainer  where (bcf15tgl between '$in_tglawal' and '$in_tglakhir') and perintah='1' and bcf15.idbcf15=bcfcontainer.idbcf15  order by idcontainer desc  ";
    $q   = mysql_query( $sql );
    
    while( $r=mysql_fetch_array( $q ) ){
        $statusupload='BCF15CONT';
    ...
    header("Content-Disposition: attachment; filename=CONT$bcfbaru.xls");
