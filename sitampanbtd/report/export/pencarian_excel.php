...
if(isset($_GET['search1'])){
    ...
    $title = "<font size=5 face=arial><b>HASIL PENCARIAN</b></font>";
    $title1 = "";
    ...
    $sql = "SELECT idbcf15,bcf15no,bcf15.tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,
                    ...
                    amountbrg,satuanbrg,BatalTarikNo,BatalTarikNo2,BatalTarikDate,BatalTarikKet,tglbukaposbc11ceisa,idstatusakhir,NoKepStatus_Akhr,KepLelang1No,KepLelang1Date,KepLelang2No,KepLelang2Date,KepMusnahNo,KepMusnahDate,KepBMNNo,KepBMNDate
                        FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and bcf15.idtpp=tpp.idtpp and  recordstatus='2' and  ".$bagianWhere."  order by bcf15.idbcf15 ASC  ";
    $q   = mysql_query( $sql );
    $awal='1';
