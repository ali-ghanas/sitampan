...
if(isset($_GET['search'])){
    ...
    $sql = "SELECT idbcf15,bcf15no,bcf15.tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,
                    ...
                    amountbrg,satuanbrg,BatalTarikNo,BatalTarikNo2,BatalTarikDate,BatalTarikKet,tglbukaposbc11ceisa
                        FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and bcf15.idtpp=tpp.idtpp and  recordstatus='2' and masuk='2' and tahun='$tahunget' and MONTH(bcf15tgl)='$bulanget'  order by bcf15.idbcf15 desc  ";
    $q   = mysql_query( $sql );
