...
//    $tahun=$_GET['tahun'];
    ...
    $title = "<font size=5 face=arial><b>Daftar BCF 1.5 yang Telah di batalkan</b></font>";
    $title1 = "";
    ...
    $sql = "SELECT * FROM bcf15,tpp,seksi where ((bcf15no LIKE '%$in_katakunci%') 
                                    OR (blno LIKE '%$in_katakunci%') OR (consignee LIKE '%$in_katakunci%') OR (notify LIKE '%$in_katakunci%')) and (bcf15tgl between '$in_tglawal' and '$in_tglakhir') and bcf15.idtpp LIKE '%$in_tpp%' and recordstatus='2' and bcf15.idtpp=tpp.idtpp and bcf15.idseksi=seksi.idseksi and batal='1'  ";
    $q   = mysql_query( $sql );
