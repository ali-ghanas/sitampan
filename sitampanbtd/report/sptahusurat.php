<?php
                   include '../lib/koneksi.php';
                    ...
                    $bcf15['suratdate'] = formatDate($bcf15['suratdate']);
                    $bcf15['bcf15tgl'] = formatDate($bcf15['bcf15tgl']);
                    $bcf15['bc11tgl'] = formatDate($bcf15['bc11tgl']);
                    $bcf15['bltgl'] = formatDate($bcf15['bltgl']);
...
<div><font face="arial" >
                        <form method="POST">
                            ...
                            <table width="100%" border="0">
                                <tr><td width="12%">Nomor</td><td width="1%">:</td><td width="50%">S-<?php echo $bcf15['suratno'] ?><?php echo $bcf15['kd_tp3'] ?><?php echo $bcf15['tahun'] ?></td><td align="right"><?php echo $bcf15['suratdate'] ?></td></tr>
                            ...
                            <table border="0" width="400">
                                ...
                                <tr><td></td><td height="4" colspan="5"></td></tr>
                                <tr><td colspan="5">Yth. Pimpinan <?php if ($bcf15['consignee']=="To Order") {echo $bcf15['notify']; } elseif ($bcf15['consignee']=="to order") {echo $bcf15['notify']; } elseif ($bcf15['consignee']=="toorder") {echo $bcf15['notify']; } elseif ($bcf15['consignee']=="ToOrder") {echo $bcf15['notify']; } else  {echo $bcf15['consignee'];};?></td></tr>
                            ...
                            <table>
                                ...
                                <tr><td align="left" colspan="3" valign="top" ></td><td  colspan="2" valign="top" align="right" >
                                        <table border="0"><tr><td>an.</td><td> KABID PFPC II</td></tr><tr><td></td><td>u.b.</td></tr><tr><td></td><td>KASI PABEAN III</td></tr><tr><td height="70"></td></tr><tr><td></td><td ><?php echo $bcf15['nm_seksi'] ?></td></tr><tr><td></td><td>NIP. <?php echo $bcf15['nip'] ?></td></tr></table></td></tr>
