                    ...
                    <input class="button putih bigrounded " type="button"  value="Print dan Preview" onClick="popup_print()"/>
                        ...
                        <form method="POST">
                            <table width="100%" border="0">
                                ...
                                <tr><td></td><td height="4" colspan="5"></td></tr>
                                <tr><td></td><td colspan="5">Yth. <?php if ($bcf15['consignee']=="To Order") {echo $bcf15['notify']; } elseif ($bcf15['consignee']=="to order") {echo $bcf15['notify']; } elseif ($bcf15['consignee']=="toorder") {echo $bcf15['notify']; } elseif ($bcf15['consignee']=="ToOrder") {echo $bcf15['notify']; } else  {echo $bcf15['consignee'];};?></td></tr>
