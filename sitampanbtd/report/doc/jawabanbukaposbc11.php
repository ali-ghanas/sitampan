...
include '../../lib/function.php';
                    ...
                    $sql = "SELECT * FROM bcf15, seksi, tpp WHERE  bcf15.idtpp=tpp.idtpp  and bcf15.jawaban_bukaposbc11seksi=seksi.idseksi and idbcf15='$id' "; // memanggil data dengan id yang ditangkap tadi
                    $query = mysql_query($sql);
                    $bcf15 = mysql_fetch_array($query);
        

if ($bcf15['kdseksi']=="manifest") {$kop='/KPU.01/BD.0504/'; } 
$tglbukaposbc11ceisa=$bcf15['jawaban_bukaposbc11tgl'];
...
$jawaban_bukaposbc11no=$bcf15['jawaban_bukaposbc11no'];
$jawaban_bukaposbc11tgl=tglindo($bcf15['jawaban_bukaposbc11tgl']);
...
$satuanbrg=$bcf15['satuanbrg'];
                                ...
                                $sqlseksi = "SELECT * FROM bcf15, seksi WHERE  bcf15.jawaban_bukaposbc11seksi=seksi.idseksi and idbcf15='$id' "; // memanggil data dengan id yang ditangkap tadi
...
$document = file_get_contents("jawabanbukaposbc11.rtf");
$document = str_replace("%%nondjwb%%", $jawaban_bukaposbc11no, $document);
$document = str_replace("%%tglndjwb%%", $jawaban_bukaposbc11tgl, $document);
...
header("Content-disposition: inline; filename=nd-$jawaban_bukaposbc11no(jwbbukapos).rtf");
