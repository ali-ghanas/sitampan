...
if(isset($_GET['search'])){
    ...
    $sql = "SELECT * FROM bcf15,tpp where bcf15.idtpp=tpp.idtpp and (tglbukaposbc11ceisa between '$in_tglbukaposbc11ceisa_1' and '$in_tglbukaposbc11ceisa_2') and setujubatal='2'  ";
    $q   = mysql_query( $sql );
