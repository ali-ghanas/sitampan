...
<?php // aksi untuk edit
    ...
    if(isset($_POST['cetakpemberitahuanall'])) // jika tombol editsubmit ditekan
            ...
            $sql = "SELECT * FROM bcf15, seksi, tp3, tpp WHERE  bcf15.idtpp=tpp.idtpp and bcf15.idseksitp3=seksi.idseksi and bcf15.idtp3=tp3.idtp3 and suratdate  between '$txttgldari' and '$txttglsampai' order by suratno "; // memanggil data dengan id yang ditangkap tadi
