...
if(isset($_GET['search'])){
    ...
    //definisikan nama tpp
    $sql1 = "SELECT * FROM bcf15,tpp where bcf15.idtpp=tpp.idtpp and  bcf15.idtpp like '%$tpp%' and bcf15tgl between '$txttgldari' and '$txttglsampai'  ";
    $q1   = mysql_query( $sql1 );
    $r1=mysql_fetch_array( $q1 );
    
    $title = "<font size='5' color='red'>Daftar BCF 1.5 ".$r1['nm_tpp']."</font><br/>";
    ...
    $sql = "SELECT * FROM bcf15 where idtpp like '%$tpp%' and bcf15tgl between '$txttgldari' and '$txttglsampai'  ";
    $q   = mysql_query( $sql );
    ...
    header("Content-Disposition: attachment; filename=export to excel data BCF 1.5 di tpp.xls");
