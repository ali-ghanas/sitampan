...
if(isset($_GET['search'])){
    ...
    $sql = "SELECT * FROM bcf15 where ((consignee like '%$txtimportir%') or (notify like '%$txtimportir%')) and bcf15tgl between '$txttgldari' and '$txttglsampai' and masuk like '$cmbtarik'  ";
    $q   = mysql_query( $sql );
    ...
    header("Content-Disposition: attachment; filename=export to excel data BCF 1.5 di tps.xls");
