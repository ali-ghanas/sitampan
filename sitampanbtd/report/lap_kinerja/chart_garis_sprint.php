<form method="post" id="addbcf15" name="addbcf15" action="?hal=rekap_capaian_kinerja&pilih=sprint">
<table >
    <tr>
...
<html>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				chart = new Highcharts.Chart({
					...
					title: {
						text: 'Grafik Perbandingan Penerbitan BCF 1.5 dan Surat Perintah'
					},
					subtitle: {
	...
	<body>
		...
		<div id="container2" style="width: 800px; height: 400px; margin: 0 auto"></div><br>
                <div id="container3" style="width: 800px; height: 400px; margin: 0 auto"></div><br>
                ...
                $sql = "SELECT idlap_kinerja_bulan,nm_bulan,bulan,Tahun,lap_tap_bcf15,lap_sprint FROM lap_kinerja,lap_kinerja_bulan where lap_kinerja.bulan=lap_kinerja_bulan.idlap_kinerja_bulan ";
                $qry = mysql_query($sql);
