                    ...
                    <form method="post" id="addbcf15" name="addbcf15" action="?hal=lap_data&pilih=lap_batal">
                    <table >
                    ...
                    <table border="0" width="100%">
                                <tr><td colspan="9"><h1>Total BCF 1.5 Setuju Batal</h1></td></tr>
                                <tr>
                                    ...
                                    <?php 
                                     ...
                                     if (empty($bagianWhere))
                                           ...
                                           else
                                           {
                                            ...
                                            $sql = "SELECT count(bcf15no) as jumbcf, tahun FROM bcf15 where setujubatal='1' and ".$bagianWhere." group by tahun order by tahun asc  ";
                                            $query   = mysql_query( $sql );
                                            while ($data1=mysql_fetch_array( $query ))
                                 {

                                 echo "<td class='judultabel' width='50'>$data1[tahun]</td>";//tentukan taun
                                ...
                                <?php 
                                       ...
                                       $no=1;    
                                            ...
                                            $query1   = "SELECT count(bcf15no) as jumbcf, tahun,DATE_FORMAT(SetujuBatalDate,'%m') as bulan, DATE_FORMAT(SetujuBatalDate,'%M') as bulan1 FROM bcf15 group by bulan order by bulan asc";
                                                ...
                                                
                                 {
                                   ...
                                   echo "<td class='isitabel'>$no</td><td class='isitabel'>$data1[bulan1]</td>";  //tentukan bulan

                                   //query untuk menampilkan tahun berapa saja dalam tabel BCF 1.5
                                   $query3="select distinct (tahun) as tahun from bcf15 where setujubatal='1' and ".$bagianWhere."   order by tahun asc";
                                   ...
                                   while ($data3=  mysql_fetch_array($hasil3))
                                   {
                                       ...
                                       $query4="select count(SetujuBatalNo) as jumlahbcf,DATE_FORMAT(SetujuBatalDate,'%m') as bulan, idtypecode,tahun from bcf15 where  DATE_FORMAT(SetujuBatalDate,'%m')='$bulan' and setujubatal='1' and ".$bagianWhere."    ";
