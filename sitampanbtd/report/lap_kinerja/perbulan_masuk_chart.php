...
$menu4masuktot=array();
$sqlmasuktot = "SELECT count(bcf15no) as jumbcf FROM bcf15,typecode where bcf15.idtypecode=typecode.idtypecode and tahun='$tahunget' and MONTH(bcf15tgl)='$bulanget' and pecahpos='2' and recordstatus='2' and masuk='1'  ";
...
//fcl
$menu4fcl=array();
$sql4fcl = "SELECT count(bcf15no) as jumbcf FROM bcf15,typecode where bcf15.idtypecode=typecode.idtypecode and tahun='$tahunget' and MONTH(bcf15tgl)='$bulanget' and pecahpos='2' and recordstatus='2' and bcf15.idtypecode='1' and masuk='1'  ";
...
//lcl
$menu4lcl=array();
$sql4lcl = "SELECT count(bcf15no) as jumbcf FROM bcf15,typecode where bcf15.idtypecode=typecode.idtypecode and tahun='$tahunget' and MONTH(bcf15tgl)='$bulanget' and pecahpos='2' and recordstatus='2' and bcf15.idtypecode='2' and masuk='1' ";
...
//partoff
$menupo=array();
$sqlpo = "SELECT count(bcf15no) as jumbcf FROM bcf15,typecode where bcf15.idtypecode=typecode.idtypecode and tahun='$tahunget' and MONTH(bcf15tgl)='$bulanget' and pecahpos='2' and recordstatus='2' and bcf15.idtypecode='3' and masuk='1'  ";
...
//short ship
$menuss=array();
$sqlss = "SELECT count(bcf15no) as jumbcf FROM bcf15,typecode where bcf15.idtypecode=typecode.idtypecode and tahun='$tahunget' and MONTH(bcf15tgl)='$bulanget' and pecahpos='2' and recordstatus='2' and bcf15.idtypecode='4' and masuk='1' ";
...
//empty cont
$menuec=array();
$sqlec = "SELECT count(bcf15no) as jumbcf FROM bcf15,typecode where bcf15.idtypecode=typecode.idtypecode and tahun='$tahunget' and MONTH(bcf15tgl)='$bulanget' and pecahpos='2' and recordstatus='2' and bcf15.idtypecode='5' and masuk='1' ";
...
//iso tank
$menuit=array();
$sqlit = "SELECT count(bcf15no) as jumbcf FROM bcf15,typecode where bcf15.idtypecode=typecode.idtypecode and tahun='$tahunget' and MONTH(bcf15tgl)='$bulanget' and pecahpos='2' and recordstatus='2' and bcf15.idtypecode='6' and masuk='1' ";
...
//reffer
$menurf=array();
$sqlrf = "SELECT count(bcf15no) as jumbcf FROM bcf15,typecode where bcf15.idtypecode=typecode.idtypecode and tahun='$tahunget' and MONTH(bcf15tgl)='$bulanget' and pecahpos='2' and recordstatus='2' and bcf15.idtypecode='7' and masuk='1'  ";
