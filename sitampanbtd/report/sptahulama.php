        ...
        <div id="sprint">
                ...
                <?php
                   include '../lib/koneksi.php';
                    ...
                    ?>
                    <a href="report/sptahusuratlama.php?sptahu=<?php echo  $bcf15['suratno']; ?> & tahun=<?php echo  $bcf15['tahun']; ?>" target="new">Print Surat</a>
                        <form method="POST">
                            <table width="100%" border="0">
                                ...
                                <tr><td></td><td width="9%">Nomor</td><td width="1%">:</td><td width="50%">S-<?php echo $bcf15['suratno'] ?><?php echo $bcf15['kd_tp3'] ?><?php echo $bcf15['tahun'] ?></td><td align="right"><?php echo $bcf15['suratdate'] ?></td></tr>
                                ...
                                <tr><td></td><td height="4" colspan="5"></td></tr>
                                <tr><td></td><td colspan="5">Yth. Pimpinan <?php if ($bcf15['consignee']=="Notify Party") {echo $bcf15['notify']; } else  {echo $bcf15['consignee'];;};?></td></tr>
                                <tr><td></td><td colspan="5"><?php if ($bcf15['consignee']=="Notify Party") {echo $bcf15['notifyadrress']; } else  {echo $bcf15['consigneeadrress'];;};?></td></tr>
                                <tr><td></td><td colspan="5"><?php if ($bcf15['consignee']=="Notify Party") {echo $bcf15['notifykota']; } else  {echo $bcf15['consigneekota'];;};?></td></tr>
                                <tr><td></td><td height="5" colspan="4"></td></tr>
                                <tr><td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font >Diberitahukan dengan hormat bahwa berdasarkna Undang-Undang Nomor 10 Tahun 1995 tentang Kepabeanan sebagaimana diubah dengan Undang-Undang Nomor 17 Tahun 2006 dan Peraturan Menteri Keuangan nomor : 62/PMK.04/2011 tentang Penyelesaian Terhadap Barang Yang Dinyatakan Tidak Dikuasai, Barang Yang Dikuasai Negara dan Barang Yang Menjadi Milik Negara maka terhadap barang impor Suadara dengan data :</font></td></tr>
                                <tr><td height="5" colspan="6"></td></tr>
                                <tr><td colspan="3">BC 1.1</td><td colspan="2"  valign="top" >: <?php echo $bcf15['bc11no'] ?> / Pos <?php echo $bcf15['bc11pos'] ?> Tanggal <?php echo $bcf15['bc11tgl'] ?></td></tr>
                                <tr><td colspan="3">Nama Kapal/Voy</td><td colspan="2"  valign="top" >: <?php echo $bcf15['saranapengangkut'] ?> / <?php echo $bcf15['voy'] ?></td></tr>
                                <tr><td colspan="3">BCF 1.5 / Tgl</td><td colspan="2"  valign="top" >: <?php echo $bcf15['bcf15no'] ?> / <?php echo $bcf15['bcf15tgl'] ?></td></tr>
                                <tr><td colspan="3">Lokasi Penimbunan</td><td colspan="2"  valign="top" >: <?php echo $bcf15['nm_tpp'] ?> </td></tr>
                                ...
                                <tr><td colspan="3">Nomor B/L</td><td colspan="2"  valign="top" >: <?php echo $bcf15['blno'] ?> / <?php echo $bcf15['bltgl'] ?> </td></tr>
                                ...
                                <tr><td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;an. Kepala Kantor </font></td></tr>
                                <tr><td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kabid Pelayanan Pabean dan Cukai II </font></td></tr>
                                <tr><td align="left" colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;u.b. </font></td></tr>
                                <tr><td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $bcf15['jabatan'] ?> </font></td></tr>
                                ...
                                <tr><td align="left" valign="top" >3.&nbsp;&nbsp;&nbsp;</td><td colspan="4" valign="top"><p style="text-align: justify">Pengusaha Pelayaran <?php echo $bcf15['nm_pelayaran'] ?>.</p></td></tr>
