...
//$nourut=1;
?>
<form method="post" action=<?php echo "index.php?hal=browsehistory"; ?> >
...
$reload = "index.php?hal=browsehistory";
...
// counting the offset
$limit = ($nohal - 1) * $rpp;
$sqltampil = "SELECT * FROM bcf15 LIMIT $limit,$rpp" ;
...
<td align="center" class="isitabel"><a href="?hal=historybcf15&nobcf15=<?php echo  $data['bcf15no']; ?> & tahun=<?php echo  $data['tahun']; ?>">Lihat History</a>  
</td>
</tr>
<?php
};
