...
$sql = mysql_query("SELECT * FROM sentitems WHERE SendingDateTime BETWEEN '$_POST[tanggal1]' AND '$_POST[tanggal2]'");
?>
<?php
...
echo "<table border=1 cellpadding=0 cellspacing=0>
		...
		<tr>
			<td colspan=2 bgcolor=yellow style='border: none';>Laporan Pesan Terkirim (Sentitems)</td>
		</tr>
		<tr>
			<td bgcolor=#c6e1f2 align=center><b>SendingDateTime</b></td>
			<td bgcolor=#c6e1f2 align=center><b>DeliveryDateTime</b></td>
			<td bgcolor=#c6e1f2 align=center><b>DestinationNumber</b></td>
			<td bgcolor=#c6e1f2 align=center><b>TextDecoded</b></td>
			<td bgcolor=#c6e1f2 align=center><b>Status</b></td>
		</tr>";
