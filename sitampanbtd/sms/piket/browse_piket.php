   ...
   <script type="text/javascript" src="lib/js/spritelymenu/jquery-ui-1.8.11.custom.min.js"></script>
    ...
    <body>
                    ...
                    */
                    ...
                    <form method="post" action=<?php echo "index.php?hal=sms_piketbrowse"; ?> >
                    ...
                    $reload = "index.php?hal=sms_piketbrowse";

                    // data mentah 
                    $sql = "SELECT *  FROM  sms_kegiatan_tpp where status_sms='' and  ".$bagianWhere." order by tgl_kegiatan desc ";
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT *  FROM  sms_kegiatan_tpp where  status_sms='' and ".$bagianWhere."   order by tgl_kegiatan desc LIMIT $limit,$rpp";
                    ...
                    $sql = "SELECT *  FROM  sms_kegiatan_tpp where status_sms='' order by tgl_kegiatan desc";
                    $result = mysql_query($sql);
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT *  FROM  sms_kegiatan_tpp where status_sms=''   order by tgl_kegiatan desc LIMIT $limit,$rpp" ;
        ...
        <br/>
                ...
                <div id="batarik">
                             <ul>
                                  <li><a href="#tabs-2">SMS Belum Terkirim</a></li>
                   ...
                   <td class="isitabel"><a href="?hal=sms_pikethapus&id=<?php echo  $data['idsms_kegiatan_tpp'];?>" onclick="javascript:return confirm('Yakin Hapus SMS ini ?')">Hapus</a></td>
                    ...
                    <?php
                        ...
                        echo "<tr><td colspan=7 class=isitabel>TIDAK ADA SMS YANG AKAN DIKIRIM</td></tr>";
                    }
                    ?>
                    </table>
