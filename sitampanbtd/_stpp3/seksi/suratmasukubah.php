...
if(isset($_POST['addsubmit2'])) // jika tombol editsubmit ditekan
	{               
		...
		$edit = mysql_query("UPDATE suratmasuk SET
			...
			// Konfirmasi Sukses
			echo '<script type="text/javascript">window.location="index.php?hal=browsesuratmasuktpp3&act=1"</script>';
	...
	$data = mysql_fetch_array($query);
        ...
        <form method="post" id="disposisisurattpp3" name="disposisisurattpp3" action="?hal=disposisisurattpp3">
