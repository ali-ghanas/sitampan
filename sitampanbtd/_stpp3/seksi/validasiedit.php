...
if(isset($_POST['editsubmit'])) // jika tombol editsubmit ditekan
	{               
		...
		echo '<script type="text/javascript">window.location="index.php?hal=validasitpp3&pilih=Masukdariloket"</script>';
//               echo $bcf15no;
//               echo $txtsekarang;
//               echo $tahun;
        }
	...
	$data = mysql_fetch_array($query);
        ...
        <input type="hidden" name="bcf15no" value="<?php echo  $data['bcf15no']; ?>" />
           ...
           <tr>
            ...
            <tr><td><input type="submit" name="editsubmit" class="button putih bigrounded " value="validasi" onclick="javascript:return confirm('Anda Yakin?')" /></td><td colspan="3"><input type="button" class="button putih bigrounded "  value="Cancel" onclick="self.history.back()" /></td></tr>
