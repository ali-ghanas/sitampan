...
<form method="post" action=<?php echo "index.php?hal=suratpemberitahuan"; ?> >
    <table border="0">
        <tr>
            <td class="isitabel">
                <h2>Surat Pemberitahuan BCF 1.5</h2><hr/>
                            ...
                            <td >
                                ...
                                <table BORDER="0" bgcolor="#f2f5ad"  class="isitabel">
                                    ...
                                    <tr>
                                     ...
                                     <td><input type="text"  class="required" name="suratno" value="<?php echo $_POST['suratno']?>">  </td>
                                    </tr>
                                    <tr>
                                     ...
                                     <tr>
                                     <td><input type="checkbox" name="dokumenNo" value="1"  <?php  if($_POST['dokumenNo'] == 1){echo 'checked="checked"';}?>>Dokumen Pemberitahuan </td>
                                     <td><input type="text"  class="required" name="DokumenNo" value="<?php echo $_POST['DokumenNo']?>">  </td>
                                     
                                     <td><input type="checkbox" name="dokumen2No" value="1"  <?php  if($_POST['dokumen2No'] == 1){echo 'checked="checked"';}?>>Dokumen Pengeluaran </td>
                                     <td><input type="text"  class="required" name="Dokumen2No" value="<?php echo $_POST['Dokumen2No']?>">  </td>
                                     </tr>
                                     <tr>
...
if (($mode=='cari')) {
                        ...
                        if (isset($_POST['Bcf15no']))
                                        ...
                                        if (isset($_POST['Suratno']))
                                        {
                                           ...
                                           if (empty($bagianWhere))
                                           {
                                                $bagianWhere .= "suratno like '%$suratno%'";
                                           }
                                           else
                                           {
                                                $bagianWhere .= " AND suratno like '%$bc11pos%'";
                                           }
                                        }
                                        if (isset($_POST['Blno']))
                                        {
       ...
       if ($_POST['PencarianBebas']=='1') {
           ...
           $rpp = 20; // Jumlah data per halaman 
                    ...
                    // data mentah 
                    $sql = "SELECT idbcf15,bcf15no,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,consignee,notify,suratno,suratdate,SetujuBatalNo,SetujuBatalDate,setujubatal FROM bcf15 where ".$bagianWhere." and  pemberitahuan='1' order by bcf15tgl desc ";
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT idbcf15,bcf15no,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,consignee,notify,suratno,suratdate,SetujuBatalNo,SetujuBatalDate,setujubatal FROM bcf15 where ".$bagianWhere." and pemberitahuan='1'  order by bcf15tgl desc LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT idbcf15,bcf15no,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,consignee,notify,suratno,suratdate,SetujuBatalNo,SetujuBatalDate,setujubatal FROM bcf15 where pemberitahuan='1' order by bcf15tgl desc";
                    $result = mysql_query($sql);
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT idbcf15,bcf15no,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,consignee,notify,suratno,suratdate,SetujuBatalNo,SetujuBatalDate,setujubatal FROM bcf15 where  pemberitahuan='1' order by bcf15tgl desc  LIMIT $limit,$rpp" ;
                   ...
                   <?php 
                    ...
                    <td class="isitabel" title="Edit Surat Pemberitahuan"><?php  if ($data['suratno']==''){echo ''; }else{ echo "<a href=?hal=sptahuview&id=$data[idbcf15] target=_blank  title='Edit Surat Pemberitahuan'>$data[suratno] </a>";} ?></td>
                    <td class="isitabel"><?php echo tglindo($data['suratdate']); ?></td>
