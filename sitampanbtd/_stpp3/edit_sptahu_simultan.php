...
<html>
   ...
   <script type="text/javascript" src="lib/js/spritelymenu/jquery-ui-1.8.11.custom.min.js"></script>
    ...
    <body>
        ...
        <form method="post" id="editsptahu" name="editsptahu" action="?hal=pagetpp3&pilih=edit_sptahu_sim_proses" >
                ...
                <tr >
                    <td >
                        <table class="groupmodul1" >
                            <tr>
                                <td colspan="3" class="judulbreadcrumb">Modul Edit Surat Pemberitahun</td>
                            </tr>
                            <tr valign="top">
                                <td colspan="3">Modul ini digunakan untuk mengedit data surat pemberitahuan, adapun langkah langkah dalam menjalankan modul ini adalah sebagai berikut:</td>
                            </tr>
                            <tr valign="top">
                            ...
                            <tr valign="top">
                                <td colspan="2">2</td><td>Tentukan rentang waktu surat pemberitahuan yang akan diedit. Parameter tanggal yang dipakai adalah parameter <b>Tanggal SUrat Pemberitahuan</b></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <table border="0" class="isitabel">
                            ...
                            <tr>
                                <td  align="left" width="20%" colspan="2">Tanggal Surat Berdasarkan Tanggal Surat Pemberitahuan </td> 
