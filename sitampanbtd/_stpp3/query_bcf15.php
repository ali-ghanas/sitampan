...
<!--        <link rel="stylesheet" type="text/css" href="themes/main.css" />-->
    ...
    <body>
                   ...
                   <?php // yang belum koneksi database diabaikan aja dulu file ini
                    ...
                    ?>
                    <form method="post" action=<?php echo "index.php?hal=pagetpp2&pilih=daf_bcf15"; ?> >
                    <table> 
                    ...
                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp where bcf15.idtpp=tpp.idtpp order by bcf15tgl desc ";
                    $result = mysql_query($sql);
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15,tpp where bcf15.idtpp=tpp.idtpp order by bcf15tgl desc LIMIT $limit,$rpp" ;
                    ...
                    <td align="center" class="isitabel"><?php echo "<a href='?hal=pagetpp3&pilih=edit_bcf15&id=$data[idbcf15]' target='_new'><img src='images/new/update.png'  title='Edit BCF 1.5'/></a> ";   ?> </td>
