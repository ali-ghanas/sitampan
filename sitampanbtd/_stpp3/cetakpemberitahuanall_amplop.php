...
<html>
    ...
    <body>
        ...
        <form method="get" id="cetakpemberitahuanall" name="cetakpemberitahuanall" action="report/cetakamplop_ke_excel.php" target="new">
            ...
            <tr><td><input class="button putih bigrounded " type="submit" name="cetakpemberitahuanallamplop" value="Cetak" /></td><td><input class="button putih bigrounded " type="button" value="Cancel" onclick="self.history.back()" /></td></tr>
