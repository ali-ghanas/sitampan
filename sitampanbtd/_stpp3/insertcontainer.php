...
<form method="post" id="addcont" name="addcont" action="?hal=pagetpp3&pilih=insert_cont">
...
if(isset($_POST['addsubmit'])) // jika tombol addsubmit ditekan
	{
		...
		VALUES(
               ...
               echo "<script type='text/javascript'>window.location='index.php?hal=pagetpp3&pilih=edit_bcf15&id=$idbcf15'</script>";
               }
               else{
                   echo "belum berhasil";
               }
