...
//                echo  $txtbc11tgl;
		...
		$edit = mysql_query("UPDATE bcf15 SET
                ...
                mysql_query("INSERT INTO historybcf15(namaaksi, tanggalaksi,bcf15no,tahun,nama_user,nip_user)VALUES('Edit BCF 1.5','$tglkini','$txtnobcf15','$tahun','".$_SESSION['nm_lengkap']."','".$_SESSION['nip_baru']."')");
                    ...
                    echo '<script type="text/javascript">window.location="index.php?hal=pagetpp3&pilih=daf_bcf15&act=1"</script>';
	...
	$bcf15 = mysql_fetch_array($query);
        ...
        <form method="post" id="bcf15edittpp2" name="bcf15edittpp2" action="?hal=pagetpp3&pilih=edit_bcf15">
            ...
            <tr>
                <td colspan="4">
                        ...
                        <table cellspacing="2" cellpadding="3" width="50%">
                            <tr>
                                <td colspan="4">
                                    <a href="?hal=pagetpp3&pilih=insert_cont&id=<?php echo $bcf15['idbcf15']?>">Insert Container Baru</a>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="isitabel" align="center"><?php echo "<a href='?hal=pagetpp3&pilih=edit_cont&id=$bcfcont[idcontainer]' >Edit</a> ";  ?> </td>
                                <td class="isitabel" align="center"><a href="?hal=pagetpp3&pilih=del_cont&id=<?php echo $bcfcont['idcontainer']?>" target=self onclick="javascript:return confirm('Anda Yakin Hapus COntainer <?php echo $bcfcont['nocontainer']?> ?')">Delete</a></td>
                            </tr>
                            <?php };?>
                        </table>
                </td>
