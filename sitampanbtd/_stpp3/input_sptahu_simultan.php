...
<html>
    <head>
    <title>Input Surat Pemberitahuan Secara Simultan</title>
    ...
    <body>
        ...
        <form method="post" id="cetakpemberitahuanall" name="cetakpemberitahuanall" action="?hal=pagetpp3&pilih=sptahusim_formedit" >
