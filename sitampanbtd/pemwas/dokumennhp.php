...
<html>
    ...
    <body>
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <table width="100%"><tr><td class="judultabel1">Download SCAN NHP dan SKEP</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=pagebcf15pemwas&pilih=doknhp"; ?> >
                    
                        <table border="0" bgcolor="#eeefff" class="isitabel">
                        
                        <tr bgcolor="#eee">
                            <td class="isitabel" colspan="2"><b>Dibawah ini adalah hasil upload NHP, Skep BMN, BTDL, BTD Musnah dan Lainnya yang bisa Anda download PDF nya. </b></td>
                        </tr>
                        <tr valign="top">
                            <td>
                             ...
                             <td colspan="3"><input size="10" type="text" class="required"  name="NHPLelangNo" value="<?php echo $_POST['NHPLelangNo']?>">  </td>
                             </tr>
                    ...
                    $dataeload = "index.php?hal=pagebcf15pemwas&pilih=doknhp";

                    // data mentah 
                    $sql = "SELECT bcf15.idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,tundalelang,tglsuratpermohonan,idstatusakhir,nosuratpermohonan,Pemohon,masuk,NHPLelangNo,NHPLelangDate,idpemeriksa_tpp,idstatusakhir,KepLelang1No,KepLelang2No,KepLelang1Date,KepLelang2Date,KepMusnahNo,KepMusnahDate,KepBMNNo,KepBMNDate,NoKepStatus_Akhr,jenis_dok,idarsip_dok_pemeriksa
                        FROM bcf15,tpp,arsip_dok_pemeriksa  where arsip_dok_pemeriksa.idbcf15=bcf15.idbcf15 and  bcf15.idtpp=tpp.idtpp and recordstatus='2' and masuk='1' and batal='2' and ".$bagianWhere."   order by bcf15.idbcf15 desc ";
                    ...
                    $sqltampil = "SELECT bcf15.idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,tundalelang,tglsuratpermohonan,idstatusakhir,nosuratpermohonan,Pemohon,masuk,NHPLelangNo,NHPLelangDate,idpemeriksa_tpp,idstatusakhir,KepLelang1No,KepLelang2No,KepLelang1Date,KepLelang2Date,KepMusnahNo,KepMusnahDate,KepBMNNo,KepBMNDate,NoKepStatus_Akhr,jenis_dok,idarsip_dok_pemeriksa
                        FROM bcf15,tpp,arsip_dok_pemeriksa  where arsip_dok_pemeriksa.idbcf15=bcf15.idbcf15 and  bcf15.idtpp=tpp.idtpp and recordstatus='2' and masuk='1' and batal='2' and ".$bagianWhere."  order by bcf15.idbcf15 desc  LIMIT $limit,$datapp";
                    ...
                    // data mentah 
                    $sql = "SELECT bcf15.idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,tundalelang,tglsuratpermohonan,idstatusakhir,nosuratpermohonan,Pemohon,masuk,NHPLelangNo,NHPLelangDate,idpemeriksa_tpp,idstatusakhir,KepLelang1No,KepLelang2No,KepLelang1Date,KepLelang2Date,KepMusnahNo,KepMusnahDate,KepBMNNo,KepBMNDate,NoKepStatus_Akhr,jenis_dok,idarsip_dok_pemeriksa
                        FROM bcf15,tpp,arsip_dok_pemeriksa  where arsip_dok_pemeriksa.idbcf15=bcf15.idbcf15 and  bcf15.idtpp=tpp.idtpp and recordstatus='2' and masuk='1' and batal='2'  order by bcf15.idbcf15 desc ";
                    $dataesult = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $datapp;
                    $sqltampil = "SELECT bcf15.idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,tundalelang,tglsuratpermohonan,idstatusakhir,nosuratpermohonan,Pemohon,masuk,NHPLelangNo,NHPLelangDate,idpemeriksa_tpp,idstatusakhir,KepLelang1No,KepLelang2No,KepLelang1Date,KepLelang2Date,KepMusnahNo,KepMusnahDate,KepBMNNo,KepBMNDate,NoKepStatus_Akhr,jenis_dok,idarsip_dok_pemeriksa
                        FROM bcf15,tpp,arsip_dok_pemeriksa  where arsip_dok_pemeriksa.idbcf15=bcf15.idbcf15 and  bcf15.idtpp=tpp.idtpp and recordstatus='2' and masuk='1' and batal='2' order by bcf15.idbcf15 desc  LIMIT $limit,$datapp" ;
        ...
        <br/>
                    ...
                    <table border='1' class="data isitabel">
                        ...
                        <th colspan='3' class="judultabel">Dokumen</th>
                        <th rowspan='2' class="judultabel">Dowload</th>
                    ...
                    <td class="isitabel"><?php echo  $no ?></td>
                    <td class="isitabel"><?php echo  $tgl ?></td>
                    <td class="isitabel"><a href="pemwas/updatebcf15download.php?id=<?php echo  $data['idarsip_dok_pemeriksa']; ?>&jenis_dok=<?php echo  $data['jenis_dok']; ?>">Download</a></td>
