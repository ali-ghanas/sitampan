...
<html>
    ...
    <body>
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <a href="index.php?hal=pagebcf15pemwas&pilih=caricont_stripping">PERMOHONAN STRIPPING BARU KLIK <font size="3">SINI</font></a>
                    <table width="100%"><tr><td class="judultabel1">Browse Permohonan Stripping Container</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=pagebcf15pemwas&pilih=browsestrip"; ?> >
                    <table border="0">
                        <tr>
                            <td ><hr/></td>
                        </tr>
                        ...
                        <tr bgcolor="#e4ebf1">
                            <td colspan="3"><font color=""><b>PROSES PERSETUJUAN STRIPPING CONTAINER</b></font></td>
                        </tr>
                        <tr>
                            <td ><hr/></td>
                        </tr>
                    ...
                    $reload = "index.php?hal=pagebcf15pemwas&pilih=browsestrip";
                    ...
                    $sql = "SELECT bcf15.idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,Pemohon,NoKepStatus_Akhr
                        FROM bcf15,tpp,typecode,suratmasukstripping  where bcf15.idbcf15=suratmasukstripping.idbcf15 and bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and recordstatus='2' and ".$bagianWhere."   order by bcf15.idbcf15 desc ";
                    ...
                    $sqltampil = "SELECT bcf15.idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,Pemohon,NoKepStatus_Akhr
                        FROM bcf15,tpp,typecode,suratmasukstripping  where bcf15.idbcf15=suratmasukstripping.idbcf15 and bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and recordstatus='2' and ".$bagianWhere."  order by bcf15.idbcf15 desc  LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT bcf15.idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,Pemohon,NoKepStatus_Akhr
                        FROM bcf15,tpp,typecode,suratmasukstripping  where bcf15.idbcf15=suratmasukstripping.idbcf15 and bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and recordstatus='2' order by idbcf15 desc ";
                    $result = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT bcf15.idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,Pemohon,NoKepStatus_Akhr
                        FROM bcf15,tpp,typecode,suratmasukstripping  where bcf15.idbcf15=suratmasukstripping.idbcf15 and bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and recordstatus='2'  order by idbcf15 desc  LIMIT $limit,$rpp" ;
        ...
        <br/>
                    ...
                    <td align="center" class="isitabel"> <a href="?hal=pagebcf15pemwas&pilih=formstriping&id=<?php echo "$data[idbcf15]"; ?>">Rekam</a>
                    </td>
