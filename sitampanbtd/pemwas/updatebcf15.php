...
<html>
    ...
    <body>
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <table width="100%"><tr><td class="judultabel1">Update Status BCF 1.5</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=pagebcf15pemwas&pilih=update_status"; ?> >
                    
                        <table border="0" bgcolor="#eeefff" class="isitabel">
                        
                        <tr bgcolor="#eee">
                            <td class="isitabel" colspan="2"><b>Update Status BCF 1.5 adalah update manual BCF 1.5 yang telah berstatus BMN, atau BTD Siap Lelang dan sebagainya tetapi belum di input Skep BMN/Lelang/Musnah. Silahkan masukkan kriteria pencarian kemudian klik tombol cari, setelah itu pada kolom "action" diklik.</b></td>
                        </tr>
                        <tr valign="top">
                            <td>
                    ...
                    if (($mode=='cari')) {
                        ...
                        if (isset($_POST['Bcf15no']))
                                        ...
                                        {
                                           $NHPLelangDate1 = $_POST['NHPLelangDate1'];
                                           $NHPLelangDate2 = $_POST['NHPLelangDate2'];
                                           if (empty($bagianWhere))
                                           {
                   ...
                   elseif($_POST['Bmn']=='1'){
                    ...
                    $dataeload = "index.php?hal=pagebcf15pemwas&pilih=update_status";
                    ...
                    $sql = "SELECT idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,tundalelang,tglsuratpermohonan,idstatusakhir,nosuratpermohonan,Pemohon,masuk,NHPLelangNo,NHPLelangDate,idpemeriksa_tpp,idstatusakhir,KepLelang1No,KepLelang2No,KepLelang1Date,KepLelang2Date,KepMusnahNo,KepMusnahDate,KepBMNNo,KepBMNDate,NoKepStatus_Akhr
                        FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and recordstatus='2'  and setujubatal='2' and ".$bagianWhere."   group by bcf15.idbcf15 desc ";
                    ...
                    $sqltampil = "SELECT idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,tundalelang,tglsuratpermohonan,idstatusakhir,nosuratpermohonan,Pemohon,masuk,NHPLelangNo,NHPLelangDate,idpemeriksa_tpp,idstatusakhir,KepLelang1No,KepLelang2No,KepLelang1Date,KepLelang2Date,KepMusnahNo,KepMusnahDate,KepBMNNo,KepBMNDate,NoKepStatus_Akhr
                        FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and bcf15.idtpp=tpp.idtpp and  recordstatus='2'  and setujubatal='2' and ".$bagianWhere."  group by bcf15.idbcf15 desc  LIMIT $limit,$datapp";
                    ...
                    // data mentah 
                    $sql = "SELECT idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,tundalelang,tglsuratpermohonan,idstatusakhir,nosuratpermohonan,Pemohon,masuk,NHPLelangNo,NHPLelangDate,idpemeriksa_tpp,idstatusakhir,KepLelang1No,KepLelang2No,KepLelang1Date,KepLelang2Date,KepMusnahNo,KepMusnahDate,KepBMNNo,KepBMNDate,NoKepStatus_Akhr
                        FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode  and bcf15.idtpp=tpp.idtpp and recordstatus='2'  and setujubatal='2'  order by idbcf15 desc ";
                    $dataesult = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $datapp;
                    $sqltampil = "SELECT idbcf15,bcf15no,tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,tundalelang,tglsuratpermohonan,idstatusakhir,nosuratpermohonan,Pemohon,masuk,NHPLelangNo,NHPLelangDate,idpemeriksa_tpp,idstatusakhir,KepLelang1No,KepLelang2No,KepLelang1Date,KepLelang2Date,KepMusnahNo,KepMusnahDate,KepBMNNo,KepBMNDate,NoKepStatus_Akhr
                    FROM bcf15,tpp,typecode where bcf15.idtypecode=typecode.idtypecode  and bcf15.idtpp=tpp.idtpp and recordstatus='2'  and setujubatal='2' order by idbcf15 desc  LIMIT $limit,$datapp" ;
        ...
        <br/>
                                    <form name="form1" method="get" action="report/export/pemwas_exportnhp.php">
                                        <input  name="Idtpp" id="Idtpp" class="required" type="hidden" value="<?php echo $_POST['Idtpp'] ?>" />
                                        <input  name="idtpp" id="idtpp" class="required" type="hidden" value="<?php echo $_POST['idtpp'] ?>" />
                                        
                                        <input  name="bagianWhere" id="bagianWhere" class="required" type="hidden" value="<?php echo $bagianWhere ?>" />
                                        
                                        <input  name="nHPLelangDate1" id="nHPLelangDate1" class="required" type="hidden" value="<?php echo $_POST['nHPLelangDate1'] ?>" />
                                        <input  name="NHPLelangDate1" id="NHPLelangDate1" class="required" type="hidden" value="<?php echo $_POST['NHPLelangDate1'] ?>" />
                                        <input  name="nHPLelangDate2" id="nHPLelangDate2" class="required" type="hidden" value="<?php echo $_POST['nHPLelangDate2'] ?>" />
                                        <input  name="NHPLelangDate2" id="NHPLelangDate2" class="required" type="hidden" value="<?php echo $_POST['NHPLelangDate2'] ?>" />
                    ...
                    <table border='1' class="data isitabel">
                        ...
                        <th colspan='3' class="judultabel">Container</th>
                        ...
                        <th rowspan='2' class="judultabel">Edit</th>
                        <th rowspan='2' class="judultabel">Atensi</th>
                        </tr>
                        <tr><th class="judultabel">Nomor</th>
                        <th class="judultabel">Tanggal</th>
                        
                        
                        <th class="judultabel">20</th>
                        <th class="judultabel">40</th>
                        <th class="judultabel">45</th>
                    ...
                    <td class="isitabel"><?php echo  $jum_20 ?></td>
                    <td class="isitabel"><?php echo  $jum_40 ?></td>
                    <td class="isitabel"><?php echo  $jum_45 ?></td>
                    ...
                    <td class="isitabel"><a href="?hal=pagebcf15pemwas&pilih=update_status_proses&id=<?php echo $data['idbcf15'] ?>">Edit</a></td>
                    <td class="isitabel"><a href="?hal=cat_petugas&id=<?php echo $data['idbcf15'] ?>">Cat</a></td>
                    </td>
