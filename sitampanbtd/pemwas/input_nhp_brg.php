...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="2">
  ...
  <tr> 
      <td class="isitabel" width="50">Nomor </td><td class="isitabel">:</td>
        <td  class="isitabel"><? echo $bcf15['bcf15no']; ?>/<? echo $bcf15['kd_manifest']; ?>/KPU.01/BD.0504/BCF1.5/<? echo $bcf15['tahun']; ?></td>
  ...
  <?php
    ...
    if(isset($_POST['addcont'])) // jika tombol addsubmit ditekan
	{
               ...
               if ($query) {
                    ...
                    echo '<script type="text/javascript">window.location="index.php?hal=pagebcf15pemwas&pilih=saldobtd&sub_pilih=innhp"</script>';
                }
