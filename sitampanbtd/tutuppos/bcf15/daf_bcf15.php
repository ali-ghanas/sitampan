...
<html>
    ...
    <body>
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <table width="100%"><tr><td class="judultabel1">POS BCF 1.5 yang telah ditutup karena BCF 1.5 telah di Gudang Importir</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=tutuposbcf15"; ?> >
                    <table border="0" width="100%">
                        <tr>
                            <td colspan="3"><b>Penutupan pos BCF 1.5 ini dilakukan apabila POS BCF 1.5 tersebut telah diberada di gudang importir, sepanjang dilaporkan ke petugas penimbunan dengan melampirkan FC SPPB, DO atau bukti lainnya yang menyebutkan barang tersebut bukan lagi berada di TPS.</b></td>
                        </tr>
                        <tr>
                            <td colspan="3"><hr></hr></td>
                        </tr>
                        <tr>
                            <td colspan="3"><a href="?hal=tutuposbcf15">Daftar POS BCF 1.5 yang telah ditutup </a> | <a href="?hal=daf_intutuppos">Input Tutup POS BCF 1.5</a></td>
                        </tr>
                        <tr>
                            <td colspan="3"><hr></hr></td>
                        </tr>
                    ...
                    $reload = "index.php?hal=tutuposbcf15";

                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and recordstatus='2' and setujubatal='1' and tutuppos='1'  and ".$bagianWhere."   order by bcf15.idbcf15 desc ";
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and bcf15.idtpp=tpp.idtpp and  recordstatus='2' and setujubatal='1' and tutuppos='1'  and ".$bagianWhere."  order by bcf15.idbcf15 desc  LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode  and bcf15.idtpp=tpp.idtpp and recordstatus='2' and setujubatal='1' and tutuppos='1'  order by idbcf15 desc ";
                    $result = mysql_query($sql);
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15,tpp,typecode where bcf15.idtypecode=typecode.idtypecode  and bcf15.idtpp=tpp.idtpp and recordstatus='2' and setujubatal='1' and tutuppos='1'  order by idbcf15 desc  LIMIT $limit,$rpp" ;
        ...
        <br/>
                    ...
                    <table class="data" width="100%">
                            ...
                            <th class="judultabel">No Srt Tutup POS *)</th>
                    ...
                    <td align="center" class="isitabel"> <?php if ($data['idstatusakhir']=='9') {echo "BMN";}   elseif ($data['idstatusakhir']=='14') {echo 'Tutup Pos BCF 1.5 by Sistem'; } ?>
                    </td>
                    <td align="center" class="isitabel"> <?php if ($data['SuratBatalNo']=='') {echo "<a href='?hal=intutuposbcf15&id=$data[idbcf15]' target='_self'><img src=\"images/new/update.png\" ></img></a> ";}   else {echo "<a href='?hal=intutuposbcf15&id=$data[idbcf15]' target='_self'><img src=\"images/new/update.png\" ></img></a>"; } ?>
                    </td>
