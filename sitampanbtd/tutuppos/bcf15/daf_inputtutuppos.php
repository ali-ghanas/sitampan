...
<html>
    ...
    <body>
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <table width="100%"><tr><td class="judultabel1">Input Tutup POS BCF 1.5</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=daf_intutuppos"; ?> >
                    <table>
                        <tr>
                    ...
                    $reload = "index.php?hal=daf_intutuppos";

                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and recordstatus='2' and setujubatal='2'  and ".$bagianWhere."   order by bcf15.idbcf15 desc ";
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and bcf15.idtpp=tpp.idtpp and  recordstatus='2' and setujubatal='2'   and ".$bagianWhere."  order by bcf15.idbcf15 desc  LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode  and bcf15.idtpp=tpp.idtpp and recordstatus='2' and setujubatal='2'  order by idbcf15 desc ";
                    $result = mysql_query($sql);
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15,tpp,typecode where bcf15.idtypecode=typecode.idtypecode  and bcf15.idtpp=tpp.idtpp and recordstatus='2' and setujubatal='2'   order by idbcf15 desc  LIMIT $limit,$rpp" ;
        ...
        <br/>
                    ...
                    <td align="center" class="isitabel"> <?php if ($data['tutuppos']=='') {echo "<a href='?hal=intutuposbcf15&id=$data[idbcf15]' target='_self'><img src=\"images/new/update.png\" ></img></a> ";}   else {echo "<a href='?hal=intutuposbcf15&id=$data[idbcf15]' target='_self'><img src=\"images/new/update.png\" ></img></a>"; } ?>
                    </td>
