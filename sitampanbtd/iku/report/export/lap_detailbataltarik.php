...
if (isset($_POST['detailbataltarik'])) {
    ...
    $idtpp = substr($_POST['detailbataltarik'], 19, 1);
    ...
    if ($idtpp != "a") {
        $title = "<font size=5 face=arial><b align='center'>Laporan Detail Batal Tarik TPP " . $nmtpp['0'] . "</b><br><br></font>";
    } else {
        $title = "<font size=5 face=arial><b align='center'>Laporan Detail Batal Tarik Semua TPP</b><br><br></font>";
    }
    if (isset($group)) {
        $title1 = "Tanggal " . $_POST['tgl_awal'] . " sampai Tanggal " . $_POST['tgl_akhir'] . "<br><br>Format Excel ini menghilangkan nomor batal tarik yang ganda, uncheck untuk menampilkan nomor ganda!";
    } else {
        $title1 = "Tanggal " . $_POST['tgl_awal'] . " sampai Tanggal " . $_POST['tgl_akhir'] . "<br><br> Perhatian! Jumlah di baris di dalam excel berbeda dengan yang ada di page IKU Batal Tarik dikarenakan terdapat nomor Batal Tarik ganda pada format excel, jika dihilangkan nomor gandanya, jumlah Batal Tariknya akan sama! ";
    }
    ...
    if ($idtpp != 'a') {
        $req = "where bataltarikdate between '" . $_REQUEST['tgl_awal'] . "' and '" . $_REQUEST['tgl_akhir'] . "' and bataltarik='1' and idtpp='" . $idtpp . "' " . $group . " order by bataltarikdate ASC";
    } else {
        $req = "where bataltarikdate between '" . $_REQUEST['tgl_awal'] . "' and '" . $_REQUEST['tgl_akhir'] . "' and bataltarik='1' " . $group . " order by bataltarikdate ASC";
    }
