...
if (isset($_POST['detailsbatal'])) {
    ...
    if ($idtpp == 'a') {
        $sql2 = "select * from sitampan.bcf15 where setujubataldate between '" . $_REQUEST['tgl_awal'] . "' and '" . $_REQUEST['tgl_akhir'] . "' order by setujubatalno,setujubataldate asc";
    } elseif ($idtpp == 's') {
        $sql2 = "select * from sitampan.bcf15 where setujubataldate between '" . $_REQUEST['tgl_awal'] . "' and '" . $_REQUEST['tgl_akhir'] . "' and bamasukno is null order by setujubatalno,setujubataldate asc";
    } else {
        $sql2 = "select * from sitampan.bcf15 where idtpp='" . $idtpp . "' AND setujubataldate between '" . $_REQUEST['tgl_awal'] . "' and '" . $_REQUEST['tgl_akhir'] . "' and bamasukno is not null order by setujubatalno,setujubataldate asc";
    }
