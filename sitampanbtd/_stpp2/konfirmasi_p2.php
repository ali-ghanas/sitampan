...
<html>
    ...
    <body>
                   ...
                   <?php // yang belum koneksi database diabaikan aja dulu file ini
                    ...
                    ?>
        <table width="100%"><tr><td class="judultabel1">Nota Dinas Konfirmasi</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=pagemonitoring&pilih=daf_konf_p2"; ?> >
                    <table border="0">
                    ...
                    $reload = "index.php?hal=pagemonitoring&pilih=daf_konf_p2";

                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp  where bcf15.idtpp=tpp.idtpp and ((bcf15no LIKE '%$katakunci%') 
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and recordstatus='2'   order by tahun,bcf15no desc ";
                    ...
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and recordstatus='2'  order by tahun,bcf15no desc LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp where bcf15.idtpp=tpp.idtpp and recordstatus='2'    order by tahun,bcf15no desc ";
                    $result = mysql_query($sql);
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15,tpp where bcf15.idtpp=tpp.idtpp and recordstatus='2'   order by tahun,bcf15no desc LIMIT $limit,$rpp" ;
                    ...
                    <table class="data" width="100%">
                            ...
                            <th class="judultabel" colspan="2">No ND Konfirmasi</th>
                    ...
                    <td class="isitabel" align="center"><?php echo  tglindo($data['ndkonfirmasidate']) ; ?></td>
                    ...
                    <td class="isitabel" align="center"><?php echo  "$selisih" ; ?></td>
                    <td align="center" class="isitabel" title='Input ND Konfirmasi'> <?php if ($data['NoKepStatus_Akhr']=='') {echo "<a href='?hal=pagemonitoring&pilih=input_konf_p2&id=$data[idbcf15]' ><img src='images/new/update.png' title='Input ND Konfirmasi'/></a> ";}   else {echo ''; } ?> 
                    </td>
