...
<html>
    ...
    <body>
                ...
                <?php // yang belum koneksi database diabaikan aja dulu file ini
                    ...
                    ?>
                <form method="post" action=<?php echo "index.php?hal=pagemonitoring&pilih=bapenarikan"; ?> >
                <table> 
                ...
                $reload = "index.php?hal=pagemonitoring&pilih=bapenarikan";
                ...
                <td class="isitabel" align="left"><?php if ($data['masuk']=='2') {echo ''; } elseif($data['bamasukno']==''){echo ''; } else {echo "<a  href='?hal=bapenarikan&id=$data[idbcf15]' target='_new'><img src='images/new/edit_2.png' title='Edit Berita Acara Penarikan' />$data[bamasukno] </a>";} ?></td>
                ...
                <td align="center" class="isitabel"><?php if ($data['bamasukno']=='') {echo "<a href='?hal=pagemonitoring&pilih=bapenarikaninput&id=$data[idbcf15]' target='_new'><img src='images/new/update.png' title='Input Berita Acara Penarikan' /></a> ";} else {echo "";}  ?> </td>
                </tr>
                <?php
                };
                ?>
