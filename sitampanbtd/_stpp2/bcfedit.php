...
//                echo  $txtbc11tgl;
	...
	$bcf15 = mysql_fetch_array($query);
        ...
        <form method="post" id="bcf15edittpp2" name="bcf15edittpp2" action="?hal=bcf15edittpp2">
            ...
            <tr>
                <td colspan="4">
                        ...
                        <table cellspacing="2" cellpadding="3" width="50%">
                            <tr>
                                <td colspan="4">
                                    <a href="?hal=pagetpp2&pilih=insert_cont&id=<?php echo $bcf15['idbcf15']?>">Insert Container Baru</a>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="isitabel" align="center"><?php echo "<a href='?hal=editcon&id=$bcfcont[idcontainer]' target='_new'>Edit</a> ";  ?> </td>
