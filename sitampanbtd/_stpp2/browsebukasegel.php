...
<html>
    ...
    <body>
                    ...
                    ?>
                    <form method="post" action=<?php echo "index.php?hal=pagemonitoring&pilih=segel"; ?> >
                    <table> 
                    ...
                    $reload = "index.php?hal=pagemonitoring&pilih=segel";

                    // data mentah 
                    $sql = "SELECT * FROM bcf15 where ((bcf15no LIKE '%$katakunci%') 
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and masuk='2' order by tahun desc";
                    ...
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and masuk='2' order by tahun desc LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT * FROM bcf15 where masuk='2' order by tahun desc ";
                    $result = mysql_query($sql);
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15 where masuk='2' order by tahun desc LIMIT $limit,$rpp" ;
                    ...
                    <td class="isitabel"><?php echo  $data['amountbrg']; ?></td>
                    <td class="isitabel"><?php echo  $data['satuanbrg']; ?></td>
                    <td class="isitabel"><?php echo  $data['diskripsibrg']; ?></td>
                    <td class="isitabel" ><table valign="top" cellspacing="0" cellpadding="0" border="0">
                    ...
                    <td align="center" class="isitabel"><?php if ($data['ndsegelno']=='') {echo "<a href='?hal=bukasegel&id=$data[idbcf15]' target='_new'><img src='images/new/update.png' /></a> ";} else {echo "<a href='?hal=bukasegel&id=$data[idbcf15]' target='_new'>Edit</a> | <a href='?hal=cetakbukasegelok&id=$data[idbcf15]' target='_new'>Cetak</a> ";}  ?>  </td>
                    </tr>
                    <?php
                    };
                    ?>
