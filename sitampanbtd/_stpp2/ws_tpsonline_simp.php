...
$ambildata=mysql_query("select idbcf15,tahun,bcf15no,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,saranapengangkut,voy,amountbrg,satuanbrg,idtps,bcf15.idtpp,nm_tpp,tpp.idtpp,kirim_tpsol,jmlCont,nip_rekam,status,kd_tpsol
        from bcf15,tpp WHERE id='$id'",$koneksi_db);
