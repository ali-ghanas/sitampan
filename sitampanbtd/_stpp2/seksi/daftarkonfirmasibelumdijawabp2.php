...
<html>
    ...
    <body>
                   ...
                   <?php // yang belum koneksi database diabaikan aja dulu file ini
                    ...
                    ?>
                    <form method="post" action=<?php echo "index.php?hal=validasitpp2&pilih=outbox"; ?> >
                    <table border="0">
                    ...
                    $reload = "index.php?hal=validasitpp2&pilih=outbox";

                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp,seksi  where bcf15.idtpp=tpp.idtpp and ((bcf15no LIKE '%$katakunci%') 
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and bcf15.idseksindkonfirmasi=seksi.idseksi and seksi.nip like $_SESSION[nip_baru] and recordstatus='2' and recordstatuskonf='2' order by tahun desc ";
                    ...
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and bcf15.idseksindkonfirmasi=seksi.idseksi and seksi.nip like $_SESSION[nip_baru] and  recordstatuskonf='2' and recordstatus='2' order by tahun desc LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp,seksi where bcf15.idtpp=tpp.idtpp and recordstatus='2' and bcf15.idseksindkonfirmasi=seksi.idseksi and seksi.nip like $_SESSION[nip_baru] and recordstatuskonf='2'   order by tahun desc ";
                    $result = mysql_query($sql);
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15,tpp,seksi  where bcf15.idtpp=tpp.idtpp and recordstatus='2' and bcf15.idseksindkonfirmasi=seksi.idseksi and seksi.nip like $_SESSION[nip_baru] and recordstatuskonf='2'  order by tahun desc LIMIT $limit,$rpp" ;
