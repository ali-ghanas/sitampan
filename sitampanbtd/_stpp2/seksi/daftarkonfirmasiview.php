...
<html>
    ...
    <body>
                   ...
                   <?php // yang belum koneksi database diabaikan aja dulu file ini
                    ...
                    ?>
                    <form method="post" action=<?php echo "index.php?hal=validasitpp2&pilih=inbox"; ?> >
                    <table border="0">
                    ...
                    $reload = "index.php?hal=validasitpp2&pilih=inbox";

                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp,seksi where bcf15.idseksindkonfirmasi=seksi.idseksi and seksi.nip=$_SESSION[nip_baru] and bcf15.idtpp=tpp.idtpp and ((bcf15no LIKE '%$katakunci%') 
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and recordstatus='2' and (recordstatuskonf='1' or   recordstatuskonf='2' or   recordstatuskonf='3') order by tahun desc ";
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15,tpp,seksi where bcf15.idseksindkonfirmasi=seksi.idseksi and seksi.nip=$_SESSION[nip_baru] and bcf15.idtpp=tpp.idtpp and ((bcf15no LIKE '%$katakunci%') 
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and tahun LIKE '%$tahun%' and recordstatus='2' and (recordstatuskonf='1' or   recordstatuskonf='2' or   recordstatuskonf='3') order by tahun desc LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT * FROM bcf15,tpp,seksi where bcf15.idseksindkonfirmasi=seksi.idseksi and seksi.nip=$_SESSION[nip_baru] and bcf15.idtpp=tpp.idtpp and recordstatus='2' and (recordstatuskonf='1' or   recordstatuskonf='2' or   recordstatuskonf='3')   order by tahun desc ";
                    $result = mysql_query($sql);
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15,tpp,seksi where bcf15.idseksindkonfirmasi=seksi.idseksi and seksi.nip=$_SESSION[nip_baru] and bcf15.idtpp=tpp.idtpp and recordstatus='2' and (recordstatuskonf='1' or   recordstatuskonf='2' or   recordstatuskonf='3')  order by tahun desc LIMIT $limit,$rpp" ;
                    ...
                    <table class="data" width="100%">
                            ...
                            <th class="judultabel" >Lama Waktu Penumpukan di TPP</th>
                    ...
                    <td align="center" class="isitabel"> <a href="?hal=validasitpp3&pilih=validasiview&id=<?php echo  ubah_teks($data['idbcf15']); ?>" ><img src="images/new/view.png" /></a></td> 
