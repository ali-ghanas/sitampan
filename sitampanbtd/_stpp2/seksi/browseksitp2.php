<html>
    ...
    <body>
      ...
      <ul>
  	     <li><a href="#tabs-1">BROWSE SPRINT PENARIKAN BCF 15</a></li>
	     ...
	     <li><a href="#tabs-5">Help / petunjuk</a></li>
            ...
            <div id="tabs-1">
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <form method="post" action=<?php echo "index.php?hal=browseseksitpp2"; ?> >
                    ...
                    <input name="mode" type="hidden" id="mode" value="cari" /><strong bgcolor="ddffff"> Cari Berdasarkan <font color="red">No BCF 15</font>, <font color="green">BL</font>, <font color="blue">Nm Consignee</font>, <font color="blue">Notify</font> dan <font color="purple">Sprint Penarikan</font></strong>
                    </form>
                    <br />
                    ...
                    $reload = "index.php?hal=browseseksitpp2";

                    // data mentah 
                    $sql = "SELECT * FROM bcf15 where ((bcf15no LIKE '%$katakunci%') OR (suratperintahno LIKE '%$katakunci%') 
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and  perintah='1'";
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT * FROM bcf15 where ((bcf15no LIKE '%$katakunci%') OR (suratperintahno LIKE '%$katakunci%') 
                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and perintah='1' LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT * FROM bcf15 where perintah='1'";
                    $result = mysql_query($sql);
                    ...
                    <h2>Daftar BCF 1.5 yang belum diterbitkan Sprint</h2>
                    <table class="data">
                    ...
                    <td align="center" class="isitabel"><a href="?hal=viewsprintseksi&id=<?php echo  $data['idbcf15']; ?>">Sprint</a> | 
                            <a href="?hal=sprintview&id=<?php echo  $data['idbcf15']; ?>">Lihat</a>  | <a href="?hal=sprintok&sprint=<?php echo  $data['suratperintahno']; ?>&tahun=<?php echo  $data['tahun']; ?>">Cetak sprint</a> 
                    </td>
                    </tr>
                    <?php
                    };
