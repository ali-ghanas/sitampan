<html>
    <head>
    <title>View Buka Segel BCF 15</title>
    <!--       jquery anytimes -->
        ...
        <script type="text/javascript">
           $(document).ready(function() {
              $("#ndbukasegel").tabs({event:"mouseover"}).find(".ui-tabs-nav").sortable();
           });
        </script>
        <style type="text/css">
            .ui-tabs-panel {
           ...
           $(document).ready(function() {    
              $("#sprint").submit(function() {
                 if ($.trim($("#txtnd").val()) == "") {
                  ...
                  if ($.trim($("#cmbp2").val()) == "") {
                    alert("Pilih Tujuan ND ke Penindakan Berapa?");
                    $("#cmbp2").focus();
                    return false;  
                 }
    ...
    <body>
        <div id="ndbukasegel">
      <ul>
  	     <li><a href="#tabs-1">Input Buka Segel</a></li>
...
//                echo  $txtbc11tgl;
		...
		$edit = mysql_query("UPDATE bcf15 SET
                ...
                mysql_query("INSERT INTO historybcf15(namaaksi,tanggalaksi,bcf15no,tahun,nama_user,nip_user,dokupdate,tgldokupdate)VALUES('bukasegel','$txttglnd','$txtbcf15no','$txttahun','".$_SESSION['nm_lengkap']."','".$_SESSION['nip_baru']."','$txtnd','$txttglnd')");
                    echo '<script type="text/javascript">window.location="index.php?hal=browsebukasegel&act=1"</script>';
                }         
        }
        else 
	{ 
        ...
        <input type="hidden" name="txttahun" value="<?php echo $bcf15['tahun']; ?>" />
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="3">
                ...
                <tr>
                    ...
                    <td ><input name="txtnd" id="txtnd" class="required" type="text" value="<?php echo $bcf15['ndsegelno']; ?>" size="8" maxlength="6" disabled></input></td>
                    
                </tr>
                <tr>
                    <td  align="left"  >Tgl Nota Dinas : </td>
                    <td><input disabled class="required" id="tanggal" type="text" name="txttglnd" value="<?php echo $bcf15['ndsegeldate']; ?>" ></input></td>
                </tr>
                <tr>
                    <td  align="left"  >Tujuan ND Ke  : </td>
                    <td  ><select disabled id="cmbp2" name="cmbp2">
                ...
                <tr>
                    ...
                    <td colspan="2">
                    <select disabled class="required" id="cmbtpp2" name="cmbtpp2" >
