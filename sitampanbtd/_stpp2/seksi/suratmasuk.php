...
//$nourut=1;
?>
<form method="post" action=<?php echo "index.php?hal=browsesuratmasuktpp2"; ?> >
...
$reload = "index.php?hal=browsesuratmasuktpp2";

// data mentah 
$sql = "SELECT * FROM suratmasuk where ((noagenda LIKE '%$katakunci%') 
OR (nosurat LIKE '%$katakunci%') OR (perihal LIKE '%$katakunci%') OR (asalsurat LIKE '%$katakunci%')) and seksipenimbunan='1'  order by idsuratmasuk desc";
...
OR (nosurat LIKE '%$katakunci%') OR (perihal LIKE '%$katakunci%') OR (asalsurat LIKE '%$katakunci%')) and seksipenimbunan='1'  order by idsuratmasuk desc LIMIT $limit,$rpp";
...
// data mentah 
$sql = "SELECT * FROM suratmasuk where seksipenimbunan='1' order by idsuratmasuk desc";
$result = mysql_query($sql);
...
// counting the offset
$limit = ($nohal - 1) * $rpp;
$sqltampil = "SELECT * FROM suratmasuk where seksipenimbunan='1' order by idsuratmasuk desc LIMIT $limit,$rpp" ;
