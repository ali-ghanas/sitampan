...
<html>
    ...
    <body>
        <div id="ndkonfirmasi">
      <ul>
  	     <li><a href="#tabs-1">Input ND Konfirmasi Ke P2</a></li>
...
//                echo  $txtbc11tgl;
		...
		$edit = mysql_query("UPDATE bcf15 SET
                ...
                mysql_query("INSERT INTO historybcf15(namaaksi,tanggalaksi,bcf15no,tahun,nama_user,nip_user,dokupdate,tgldokupdate)VALUES('ND Konfirmasi(TPP2)','$txttglnd','$txtbcf15no','$txttahun','".$_SESSION['nm_lengkap']."','".$_SESSION['nip_baru']."','$txtnd','$txttglnd')");
