   ...
   <script type="text/javascript">
    ...
    <body>
                    ...
                    */
                    ...
                    //$nourut=1;
                    ?>
                    <table width="100%"><tr><td class="judultabel1">Daftar BTDK Yang Tidak/ Belum Dapat Di Pindahkan Ke TPP</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=lap_progres_penarikan"; ?> >
                    <table border="0">
                        ...
                        <tr>
                            <td>
                                <table BORDER="0" width="100%">
                                    ...
                                    <tr>
                                     <td >Buka Pos CEISA</td>
                                     <td colspan="2">
                                         <input type="checkbox" name="buka" value="1" <?php  if($_POST['buka'] == 1){echo 'checked="checked"';}?>/>Terbuka Pos BC 1.1 <input type="checkbox" name="tutup" value="1" <?php  if($_POST['tutup'] == 1){echo 'checked="checked"';}?> />Tertutup BC 1.1 <input type="checkbox" name="all" value="1"  <?php  if($_POST['all'] == 1){echo 'checked="checked"';}?>/> All Tidak Ditarik 
                                     </td>
                                  
                                     
                                    </tr>
                                    <tr>
                                     <td ><input type="checkbox" name="Tpp" value="1"  <?php  if($_POST['Tpp'] == 1){echo 'checked="checked"';}?>>TPP</td>
                                     <td colspan="2">
                                    ...
                                    <tr>
                                     <td ><input type="checkbox" name="Tps" value="1"  <?php  if($_POST['Tps'] == 1){echo 'checked="checked"';}?>>TPS</td>
                                     <td colspan="2"><input size="5" type="text"  class="required" name="idtps" id="tanggal" value="<?php echo $_POST['idtps']?>"> </td>
                    ...
                    if (($mode=='cari')) {
                                        ...
                                        if (isset($_POST['Tps']))
                                        {
                                           ...
                                           if (empty($bagianWhere))
                                           {
                                                $bagianWhere .= "bcf15.idtps like '%$idtpp%'";
                                           }
                                           else
                                           {
                                                $bagianWhere .= " AND bcf15.idtps like '%$idtpp%'";
                                           }
                                        }
                                        if (isset($_POST['buka']))
                                        {
                                           if (empty($bagianWhere))
                                           {
                                                $bagianWhere .= "bukaposbc11ceisa='1'";
                                           }
                                           else
                                           {
                                                $bagianWhere .= " AND bukaposbc11ceisa='1'";
                                           }
                                        }
                                        if (isset($_POST['tutup']))
                                        {
                                           if (empty($bagianWhere))
                                           {
                                                $bagianWhere .= "bukaposbc11ceisa IS NULL";
                                           }
                                           else
                                           {
                                                $bagianWhere .= " AND bukaposbc11ceisa IS NULL";
                                           }
                                        }
                                        if (isset($_POST['all']))
                                        {
                                           if (empty($bagianWhere))
                                           {
                                                $bagianWhere .= "(bukaposbc11ceisa IS NULL or bukaposbc11ceisa='1')";
                                           }
                                           else
                                           {
                                                $bagianWhere .= " AND (bukaposbc11ceisa IS NULL or bukaposbc11ceisa='1')";
                                           }
                                        }
                    ...
                    $reload = "index.php?hal=lap_progres_penarikan";
                    ...
                    $sql = "SELECT idbcf15,bcf15no,bcf15.tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,Pemohon,NoKepStatus_Akhr,perintah,suratperintahno,suratperintahdate,DokumenCode,DokumenNo,DokumenDate,Dokumen2Code,Dokumen2No,Dokumen2Date
                        FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and bcf15.idtpp=tpp.idtpp and  recordstatus='2' and masuk='2' and ".$bagianWhere."   order by bcf15.idbcf15 desc ";
                    ...
                    $sqltampil = "SELECT idbcf15,bcf15no,bcf15.tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,Pemohon,NoKepStatus_Akhr,perintah,suratperintahno,suratperintahdate,DokumenCode,DokumenNo,DokumenDate,Dokumen2Code,Dokumen2No,Dokumen2Date
                        FROM bcf15,tpp,typecode  where bcf15.idtypecode=typecode.idtypecode and bcf15.idtpp=tpp.idtpp and  recordstatus='2' and masuk='2' and ".$bagianWhere."  order by bcf15.idbcf15 desc  LIMIT $limit,$rpp";
         ...
         <?php 
                    ...
                    ?>
        <br/>
                                    <form name="form1" method="get" action="report/export/lap_excel_tpp2_belummasuk.php">
                                        ...
                                        if (isset($_POST['buka']))
                                        {
                                           if (empty($bagianWhereup))
                                           {
                                                $bagianWhereup .= "bukaposbc11ceisa='1'";
                                           }
                                           else
                                           {
                                                $bagianWhereup .= " AND bukaposbc11ceisa='1'";
                                           }
                                        }
                                        if (isset($_POST['tutup']))
                                        {
                                           if (empty($bagianWhereup))
                                           {
                                                $bagianWhereup .= "bukaposbc11ceisa IS NULL";
                                           }
                                           else
                                           {
                                                $bagianWhereup .= " AND bukaposbc11ceisa IS NULL";
                                           }
                                        }
                                        if (isset($_POST['all']))
                                        {
                                           if (empty($bagianWhereup))
                                           {
                                                $bagianWhereup .= "(bukaposbc11ceisa IS NULL or bukaposbc11ceisa='1')";
                                           }
                                           else
                                           {
                                                $bagianWhereup .= " AND (bukaposbc11ceisa IS NULL or bukaposbc11ceisa='1')";
                                           }
                                        }
                                        if (isset($_POST['Tpp']))
                                        {
                                           ...
                                           if (empty($bagianWhereup))
                                           {
                                                $bagianWhereup .= "bcf15.idtpp='$idtpp'";
                                           }
                                           else
                                           {
                                                $bagianWhereup .= " AND bcf15.idtpp='$idtpp'";
                                           }
                                        }
                                        if (isset($_POST['Tps']))
                                        {
                                           ...
                                           if (empty($bagianWhereup))
                                           {
                                                $bagianWhereup .= "bcf15.idtps like '%$idtpp%'";
                                           }
                                           else
                                           {
                                                $bagianWhereup .= " AND bcf15.idtps like '%$idtpp%'";
                                           }
                                        }
                                        $bagianWheresatu=addslashes($bagianWhereup);
                                        echo "<textarea type=hidden name=bagianwhere  >$bagianWheresatu</textarea><br/>";
                ...
                <table>
                    <tr>
                        <td>
                            Laporan Progres penarikan adalah laporan monitoring atas penarikan BCF 1.5 ke TPP yang status saat ini masih berada di TPS
                        </td>
                    </tr>
                </table>
