...
#papan{width:600;height:480;border:#efefef 1px solid;
background-color:white;overflow:hidden}
.p1{background-color:white;height:70;text-align:left;
border-bottom:#cdcdcd 1px solid;padding:5}
.x1{background-color:white;height:70;text-align:left;
border-bottom:#cdcdcd 1px solid;display:none;padding:5}
a1{color:#306DA3;text-decoration:none}
</style>
