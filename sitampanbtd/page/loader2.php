...
case 'arsippemwasupdatebcf15':$page=  include 'pemwas/pagebcf15.php';break;
case 'updatebcf15proses':$page=  include 'arsipupdatebcf15proses.php';break;
...
case 'btl_inputuploadscanspproses' :$page=  include 'arsip_btluploadscanspproses.php';break;

case 'arsip_sp_uploadscansp' :$page=  include 'arsip_sp_uploadscansp.php';break;
case 'arsip_sp_uploadscanspproses' :$page=  include 'arsip_sp_uploadscanspproses.php';break;

case 'sptahuupload_input' :$page=  include 'arsip_sptahuupload.php';break;
case 'sptahuuploadscanspproses' :$page=  include 'arsip_sptahuuploadscanspproses.php';break;
...
case 'formdatalap_bcfterbit' :$page=  include 'report/laporan/formdatabcf15terbit.php';break;
case 'datalap_bcfterbit' :$page=  include 'report/laporan/databcf15terbit.php';break;
case 'databcf15terbittpp' :$page=  include 'report/laporan/databcf15terbittpp.php';break;
...
//iku
case 'iku' :$page=  include 'iku/iku.php';break;
case 'detailiku' :$page=  include 'iku/detailiku.php';break;
