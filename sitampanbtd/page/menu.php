...
<!--        <style type="text/css">
    ...
    <body>
        ...
        if ($_SESSION['level'] == "admin") {
          ...
          <li ><a href='logout.php'><span>Log Out&nbsp;: " . $_SESSION['nm_lengkap'] . "</span></a></li>
         ...
         <ul class='nav nav-tabs' >
          ...
          <li><a href='?hal=pagemanifest&pilih=addbcf15' >BCF 1.5</a></li>
            ...
            <li><a href='#'>REPORT</a>
            <ul>
                  <li><a href='?hal=lap_bcfterbit'>Grafik</a></li>
                  <li><a href='?hal=formdatalap_bcfterbit' >Data Report</a></li>
            </ul>
            </li>
