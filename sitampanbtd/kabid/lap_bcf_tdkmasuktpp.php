    ...
    <body>
                    ...
                    */
                        ...
                        <tr>
                            <td>
                                <table BORDER="0" width="100%">
                                    ...
                                    <tr>
                                     <td ><input type="checkbox" name="Bukaposbc11ceisa" value="1"  <?php  if($_POST['Bukaposbc11ceisa'] == 1){echo 'checked="checked"';}?>>Status Buka Pos BC 1.1 di CEISA</td>
                                     <td colspan="2">
                                         <input type="checkbox" name="buka" value="1" <?php  if($_POST['buka'] == 1){echo 'checked="checked"';}?>/>Terbuka Pos BC 1.1 <input type="checkbox" name="tutup" value="0" <?php  if($_POST['buka'] == 0){echo 'checked="checked"';}?>/>Tertutup T4
                                     </td>
                    ...
                    if (($mode=='cari')) {
                                        ...
                                        if (isset($_POST['Bukaposbc11ceisa']))
                                        {
                                            
                                           $buka = $_POST['buka'];
                                           $tutup = $_POST['tutup'];
                                           if($buka=='1'){$jawab=$buka;}else {$jawab=$tutup;}
                                           if (empty($bagianWhere))
                                           {
                                                $bagianWhere .= "bukaposbc11ceisa='$jawab'";
                                           }
                                           else
                                           {
                                                $bagianWhere .= " AND bukaposbc11ceisa='$jawab'";
                                           }
                                        }
        ...
        <br/>
                                    <form name="form1" method="get" action="report/export/lap_excel_tpp2_belummasuk.php">
                                        ...
                                        <input  name="in_bukapos" id="in_bukapos" class="required" type="hidden" value="<?php if($buka=='1'){echo $jawab=1;}else {echo $jawab=0;} ?>" />
