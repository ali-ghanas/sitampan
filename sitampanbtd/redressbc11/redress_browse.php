...
<html>
    ...
    <body>
                ...
                <?php // yang belum koneksi database diabaikan aja dulu file ini
                    ...
                    ?>
                <form method="post" action=<?php echo "index.php?hal=redressbrowse"; ?> >
                <table> 
                ...
                $reload = "index.php?hal=redressbrowse";
                ...
                <td align="center" class="isitabel"><a href="?hal=redressinput&id=<?php echo $data['idbcf15']; ?>"><img src="images/new/update.png"/></a> </td>
                </tr>
                <?php
                };
                ?>
