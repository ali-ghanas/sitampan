...
<!--        <link rel="stylesheet" type="text/css" href="themes/main.css" />-->
    ...
    <body>
                   ...
                   <?php // yang belum koneksi database diabaikan aja dulu file ini
                    ...
                    ?>
                    <form method="post" action=<?php echo "index.php?hal=pagemanifest&pilih=daf_bukaposbc11ceisa"; ?> >
                    <table class="isitabel"> 
                        ...
                        <tr>
                         ...
                         <tr>
                            <td colspan="2"><font size="5" color="#4a6c41">Browse Daftar BCF 1.5 (Input Buka Pos BC 1.1)</font></td>
                        </tr>
                    ...
                    $reload = "index.php?hal=pagemanifest&pilih=daf_bukaposbc11ceisa";

                    // data mentah 
                    $sql = "select idbcf15,bcf15no,bcf15tgl,tahun,blno,consignee,notify,bc11no,bc11tgl,bc11pos,bc11subpos,idtps,bcf15.idtpp,Dokumen2Code,Dokumen2No,Dokumen2Date,jawaban_bukaposbc11,jawaban_bukaposbc11no,jawaban_bukaposbc11tgl,jawaban_bukaposbc11seksi,jawaban_bukaposbc11ket,bukaposbc11ceisa,nobukaposbc11ceisa,tglbukaposbc11ceisa,bamasukno,bamasukdate,NoKepStatus_Akhr
                    FROM bcf15 where recordstatus='2' and setujubatal='2'  and  ".$bagianWhere."   order by tahun, bcf15no asc ";
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "select idbcf15,bcf15no,bcf15tgl,tahun,blno,consignee,notify,bc11no,bc11tgl,bc11pos,bc11subpos,idtps,bcf15.idtpp,Dokumen2Code,Dokumen2No,Dokumen2Date,jawaban_bukaposbc11,jawaban_bukaposbc11no,jawaban_bukaposbc11tgl,jawaban_bukaposbc11seksi,jawaban_bukaposbc11ket,bukaposbc11ceisa,nobukaposbc11ceisa,tglbukaposbc11ceisa,bamasukno,bamasukdate,NoKepStatus_Akhr
                    FROM bcf15 where recordstatus='2' and setujubatal='2'  and  ".$bagianWhere." order by tahun,bcf15no asc  LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "select idbcf15,bcf15no,bcf15tgl,tahun,blno,consignee,notify,bc11no,bc11tgl,bc11pos,bc11subpos,idtps,bcf15.idtpp,Dokumen2Code,Dokumen2No,Dokumen2Date,jawaban_bukaposbc11,jawaban_bukaposbc11no,jawaban_bukaposbc11tgl,jawaban_bukaposbc11seksi,jawaban_bukaposbc11ket,bukaposbc11ceisa,nobukaposbc11ceisa,tglbukaposbc11ceisa,bamasukno,bamasukdate,NoKepStatus_Akhr
                        FROM bcf15 where recordstatus='2' and tahun='$tahunnow' and setujubatal='2'  order by bcf15no desc ";
                    $result = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "select idbcf15,bcf15no,bcf15tgl,tahun,blno,consignee,notify,bc11no,bc11tgl,bc11pos,bc11subpos,idtps,bcf15.idtpp,Dokumen2Code,Dokumen2No,Dokumen2Date,jawaban_bukaposbc11,jawaban_bukaposbc11no,jawaban_bukaposbc11tgl,jawaban_bukaposbc11seksi,jawaban_bukaposbc11ket,bukaposbc11ceisa,nobukaposbc11ceisa,tglbukaposbc11ceisa,bamasukno,bamasukdate,NoKepStatus_Akhr
                        FROM bcf15 where recordstatus='2' and tahun='$tahunnow' and setujubatal='2'  order by bcf15no desc LIMIT $limit,$rpp" ;
                    ...
                    <table class="isitabel">
                        ...
                        <td colspan="5" align="right"><b>Halaman ke :</b>
                            ...
                            if ($nohal > 1) echo  "<a href='".$_SERVER['PHP_SELF']."?hal=pagemanifest&pilih=daf_bukaposbc11ceisa&page=".($nohal-1)."'>&lt;&lt; Prev</a>";
                            ...
                            else echo " <a href='".$_SERVER['PHP_SELF']."?hal=pagemanifest&pilih=daf_bukaposbc11ceisa&page=".$h."'>".$h."</a> ";
                            $showPage = $h;
                            }
                            }
                            ...
                            if ($nohal < $max) echo "<a href='".$_SERVER['PHP_SELF']."?hal=pagemanifest&pilih=daf_bukaposbc11ceisa&page=".($nohal+1)."'>Next &gt;&gt;</a>";
                            ?></td>
                      </tr>
                      <tr>
                          <td>
                    ...
                    <?php if ($data['NoKepStatus_Akhr']=='') {echo "";}   else {echo 'Cek BMN atau Belum?'; }
                            ...
                            elseif($data[idstatusakhir]=='14') {echo $statusakhirname='TUTUP POS BY SISTEM (Hub Staf Penimbunan)';} 
                            elseif($data[idstatusakhir]=='0') {echo $statusakhirname='BCF15';} 
                            elseif($data[idstatusakhir]=='') {echo $statusakhirname='BCF15';}?>
                    </td>
                    <td align="center" class="isitabel"> <a href="?hal=pagemanifest&pilih=input_bukaposbc11ceisa&id=<?php  echo $data[idbcf15]?>">Buka</a>
                    </td>
