...
//$nourut=1;
?>
<form method="post" action=<?php echo "index.php?hal=allbcf15"; ?> >
...
OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) ";
...
OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%'))  LIMIT $limit,$rpp";
...
// counting the offset
$limit = ($nohal - 1) * $rpp;
$sqltampil = "SELECT idbcf15, bcf15no, DATE_FORMAT(bcf15tgl,'%d-%M-%Y') as bcf15tgl, bc11no, DATE_FORMAT(bc11tgl,'%d-%M-%Y')as bc11tgl FROM bcf15 LIMIT $limit,$rpp" ;
...
<td align="center" class="isitabel"><a href="?hal=bcf15view&id=<?php echo  $data['idbcf15']; ?>">Detail</a> | <a href="?hal=bcf15view&id=<?php echo  $data['idbcf15']; ?>">Histori BCF 1.5</a> | 
