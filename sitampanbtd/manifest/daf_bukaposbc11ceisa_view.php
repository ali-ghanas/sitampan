...
require 'lib/function.php'; 
	...
	$bcf15 = mysql_fetch_array($query);
        ...
        if($bcf15[idstatusakhir]=='2') {$statusakhirname='BCF15';} 
                            elseif($bcf15[idstatusakhir]=='4') {echo $statusakhirname="Sudah Dicacah dengan no NHP $data[NHPLelangNo] tanggal $data[NHPLelangDate] oleh nm_pemeriksa";} 
                            elseif($bcf15[idstatusakhir]=='5') {echo $statusakhirname='BTD SIAP LELANG';} 
                            elseif($bcf15[idstatusakhir]=='6') {echo $statusakhirname='BTD TIDAK LAKU L1';} 
                            elseif($bcf15[idstatusakhir]=='7') {echo $statusakhirname='BTD TIDAK LAKU L2';} 
                            elseif($bcf15[idstatusakhir]=='8') {echo $statusakhirname='BTD MUSNAH';} 
                            elseif($bcf15[idstatusakhir]=='9') {echo $statusakhirname='BMN';} 
                            elseif($bcf15[idstatusakhir]=='11') {echo $statusakhirname='PERMOHONAN TUNDA LELANG';} 
                            elseif($bcf15[idstatusakhir]=='13') {echo $statusakhirname='TIDAK LAKU LELANG';} 
                            elseif($bcf15[idstatusakhir]=='14') {echo $statusakhirname='TUTUP POS BY SISTEM (Hub Staf Penarikan)';} 
                            elseif($bcf15[idstatusakhir]=='0') {echo $statusakhirname='BCF15';} 
                            elseif($bcf15[idstatusakhir]=='') {echo $statusakhirname='BCF15';}
...
<table border="0" width="100%" >
    ...
    <tr>
        <td colspan="2" align="center"><a href="?hal=pagemanifest&pilih=query_bukaposbc11ceisa"><-Kembali-></a></td>
    </tr>
