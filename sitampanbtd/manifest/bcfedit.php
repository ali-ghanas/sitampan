...
//                echo  $txtbc11tgl;
		...
		$edit = mysql_query("UPDATE bcf15 SET
                ...
                mysql_query("INSERT INTO historybcf15(namaaksi, tanggalaksi,bcf15no,tahun,nama_user,nip_user)VALUES('Edit BCF 1.5','$tglkini','$txtnobcf15','$tahun','".$_SESSION['nm_lengkap']."','".$_SESSION['nip_baru']."')");
                    ...
                    echo '<script type="text/javascript">window.location="index.php?hal=pagemanifest&pilih=querybcf15"</script>';
...
<div id="kotakdetail">
        ...
        <input type="hidden" name="tahun" value="<?php echo  $bcf15['tahun']; ?>" />
            ...
            <tr><td  align="left"  >Consignee</td><td>:</td><td  valign="top" colspan="2"><input  class="required" id="consignee" name="txtconsignee" size="50" type="text" value="<?php echo $bcf15['consignee']; ?>" ></input></td></tr>
             <tr><td>Alamat</td><td>:</td><td colspan="4"><textarea cols="40" class="required" id="alamatconsignee" name="txtalamatconsignee" ><?php echo isset($bcf15['consigneeadrress']) ? $bcf15['consigneeadrress'] : '';?></textarea></td></tr>
             <tr><td>Kota</td><td>:</td><td colspan="4"><input class="required" id="kotaconsignee" name="txtkotaconsignee" type="text" value="<?php echo $bcf15['consigneekota']; ?>" size="10" ></input></td> </tr>
            <tr><td align="left">Notify </td><td>:</td><td colspan="3"><input class="required" id="notify" name="txtnotify" type="text" value="<?php echo $bcf15['notify']; ?>" size="30" ></input></td></tr>
            <tr><td>Alamat</td><td>:</td><td colspan="4"><textarea cols="40" class="required" id="alamatnotify" name="txtalamatnotify" ><?php echo isset($bcf15['notifyadrress']) ? $bcf15['notifyadrress'] : '';?></textarea></td></tr>
            <tr><td>Kota</td><td>:</td><td colspan="4"><input class="required" id="kotanotify" name="txtkotanotify" type="text" value="<?php echo $bcf15['notifykota']; ?>" size="10" ></input></td> </tr>
            <tr>
                 <td height="20" align="center" colspan="4" bgcolor="#dfe9ff">&nbsp;&nbsp;<b>Data TPS</b></td>
            </tr>
            <tr>
                <td >Eks TPS</td><td>:</td>
                <td colspan="4"><input class="required" id="cmbtps" name="cmbtps" type="text" value="<?php echo $bcf15['idtps']; ?>" size="10" ></input>
...
<!--            <tr>
            ...
            <tr>
                <td >Kepala Seksi Manifest </td><td>:</td>
            <td colspan="5">
            ...
            <tr>
                <td colspan="4">
                        ...
                        <table cellspacing="2" cellpadding="3" width="50%">
                            <tr>
                                <td colspan="5"><a href="?hal=manincont&id=<?php echo $bcf15['idbcf15']?>">Insert Container Baru</a></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="isitabel" align="center"><?php echo "<a href='?hal=maneditcont&id=$bcfcont[idcontainer]& id2=$bcfcont[idbcf15]' target='_new'>Edit</a> ";  ?> </td>
                                <td class="isitabel" align="center"><?php echo "<a href='?hal=mandelcont&id=$bcfcont[idcontainer]& id2=$bcfcont[idbcf15]' >Delete</a> ";  ?> </td>
