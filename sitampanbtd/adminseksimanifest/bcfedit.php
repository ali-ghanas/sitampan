...
if(isset($_POST['editsubmit3'])) // jika tombol editsubmit ditekan
	{
		...
		$txtnobcf15 = $_POST['txtbcf15no']; 
                ...
                $txtalamatconsignee = $_POST['txtalamatconsignee'];
                $txtkotaconsignee = $_POST['txtkotaconsignee'];
                $txtnotify = $_POST['txtnotify'];
                $txtalamatnotify = $_POST['txtalamatnotify'];
...
//                echo  $txtbc11tgl;
		...
		$edit = mysql_query("UPDATE bcf15 SET
                ...
                mysql_query("INSERT INTO historybcf15(namaaksi, tanggalaksi,bcf15no,tahun,nama_user,nip_user)VALUES('Edit BCF 1.5','$tglkini','$txtnobcf15','$tahun','".$_SESSION['nm_lengkap']."','".$_SESSION['nip_baru']."')");
                    ...
                    echo '<script type="text/javascript">window.location="index.php?hal=pagebcf15&pilih=editdisbcf15&act=1"</script>';
	...
	$bcf15 = mysql_fetch_array($query);
        ...
        <form method="post" id="bcf15edittpp2" name="bcf15edittpp2" action="?hal=pagebcf15&pilih=editbcf15">
            ...
            <tr>
                <td colspan="4">
                        ...
                        <table cellspacing="2" cellpadding="3" width="50%">
                            <tr>
                                <td colspan="4">
                                    <a href="?hal=pagebcf15&pilih=insert_cont&id=<?php echo $bcf15['idbcf15']?>">Insert Container Baru</a>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="isitabel" align="center"><?php echo "<a href='?hal=pagebcf15&pilih=editcon&id=$bcfcont[idcontainer]' target='_new'>Edit</a> ";  ?> </td>
                                <td class="isitabel" align="center"><a href="?hal=pagebcf15&pilih=delcon&id=<?php echo $bcfcont['idcontainer']?>" target=self onclick="javascript:return confirm('Anda Yakin Hapus COntainer <?php echo $bcfcont['nocontainer']?> ?')">Delete</a></td>
