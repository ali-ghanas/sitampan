...
//$nourut=1;
?>
<form method="post" action=<?php echo "index.php?hal=pageadminman&pilih=seksi"; ?> >
...
$reload = "index.php?hal=pageadminman&pilih=seksi";

// data mentah 
$sql = "SELECT idseksi, nm_seksi,nip,jabatan,bidang, status_seksi  FROM seksi where ((nm_seksi LIKE '%$katakunci%') 
OR (nip LIKE '%$katakunci%')) and jabatan='Kepala Seksi Adm. Manifest' and status_seksi='aktif'  ";
...
OR (nip LIKE '%$katakunci%')) and jabatan='Kepala Seksi Adm. Manifest' and status_seksi='aktif' LIMIT $limit,$rpp";
...
// data mentah 
$sql = "SELECT * FROM seksi where jabatan='Kepala Seksi Adm. Manifest' and status_seksi='aktif'";
$result = mysql_query($sql);
...
// counting the offset
$limit = ($nohal - 1) * $rpp;
$sqltampil = "SELECT * FROM seksi where jabatan='Kepala Seksi Adm. Manifest' and status_seksi='aktif' LIMIT $limit,$rpp" ;
...
<td align="center" class="isitabel"><a href="?hal=pageadminman&pilih=seksiedit&id=<?php echo  $data['idseksi']; ?>"><img src="images/new/update.png" title="Edit"/> | <a href="?hal=pageadminman&pilih=seksidel&id=<?php echo  $data['idseksi']; ?>"><img src="images/new/del.gif" title="Delete Seksi"/></a> 	
