...
<form method="post" id="tppadd" name="tppadd" action="?hal=pageadminman&pilih=addtpp">
<table border="0">
    <tr align="center"> 
    ...
    <tr><td class="judulform">Nama TPP </td><td class="judulform">:</td><td class="isitabel"> <input class="required" id="kota" name="kota" type="text" value="" /></td></tr>
    <tr>
