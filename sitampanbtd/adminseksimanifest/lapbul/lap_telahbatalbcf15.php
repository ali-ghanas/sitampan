...
<?php // yang belum koneksi database diabaikan aja dulu file ini
                                    ...
                                    ?>
                                    <form method="post" action=<?php echo "index.php?hal=pagebcf15&pilih=lapbul&sub=lapbatal"; ?> >
                                    <table> 
                                    ...
                                    $reload = "index.php?hal=pagebcf15&pilih=lapbul&sub=lapbatal";

                                    // data mentah 
                                    $sql = "SELECT * FROM bcf15,tpp,seksi where ((bcf15no LIKE '%$katakunci%') 
                                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and (bcf15tgl between '$tglawal' and '$tglakhir') and bcf15.idtpp LIKE '%$tpp%' and recordstatus='2' and bcf15.idtpp=tpp.idtpp and bcf15.idseksi=seksi.idseksi  and batal='1'  order by bcf15no,nm_tpp desc ";
                                    ...
                                    OR (blno LIKE '%$katakunci%') OR (consignee LIKE '%$katakunci%') OR (notify LIKE '%$katakunci%')) and (bcf15tgl between '$tglawal' and '$tglakhir') and bcf15.idtpp LIKE '%$tpp%' and recordstatus='2' and bcf15.idtpp=tpp.idtpp and bcf15.idseksi=seksi.idseksi  and batal='1' order by bcf15no,nm_tpp desc LIMIT $limit,$rpp";
                                    ...
                                    // data mentah 
                                    $sql = "SELECT * FROM bcf15,tpp,seksi where bcf15.idtpp=tpp.idtpp and bcf15.idseksi=seksi.idseksi and recordstatus='2' and (bcf15tgl between '$tglawal' and '$tglakhir')  and batal='1'   order by bcf15no,nm_tpp desc ";
                                    $result = mysql_query($sql);
                                    ...
                                    // counting the offset
                                    $limit = ($nohal - 1) * $rpp;
                                    $sqltampil = "SELECT * FROM bcf15,tpp,seksi where bcf15.idtpp=tpp.idtpp and bcf15.idseksi=seksi.idseksi and recordstatus='2' and (bcf15tgl between '$tglawal' and '$tglakhir')  batal='1'   order by bcf15no,nm_tpp desc LIMIT $limit,$rpp" ;
