...
<body>
    <div class="span12" >
        <div style="background-color: #75C9EA;color:#fff;border:1px">
                 <h3>STEP 1: Upload BCF 1.5 Yang Keluar TPP <img src="images/icon/png-1677.png" width="50"/></h3>
       </div>      

    <div>
        
    <span style="color:#AA9999;">Upload BCF yang Masuk TPP adalah modul upload dan Update atas BCF 1.5 yang Keluar TPP pada hanggar TPP
    ...
    <ol>
        ...
        <form method="post" enctype="multipart/form-data" name="upload" id="upload" action="?hal=upload_hgrout_proses">
         ...
         <img src="images/icon/png-1677.png"  width="50"/><a href="?hal=upload_contout">Upload Container Keluar</a>
    </div>
    </div>
</body>
</html>
