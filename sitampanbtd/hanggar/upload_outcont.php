...
<body>
    <div class="span12" >
          <h3>STEP 2 :Upload Container Yang Keluar TPP</h3>  
    ...
    <ol>
        ...
        <form method="post" enctype="multipart/form-data" name="upload" id="upload" action="?hal=upload_contout_proses">
        ...
        <img src="images/icon/png-1638.png" width="50"/><a href="?hal=upload_hgr"> Upload Pengeluaran BCF 1.5</a>
    </div>
