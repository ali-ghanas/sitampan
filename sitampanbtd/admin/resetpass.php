...
<body>
    ...
    <div >
     ...
     <form id="gantipassForm" method="post" action="?hal=resetpass">
         <table id="groupmodul1">
             ...
             <tr>
                 <td colspan="2"><input class="button putih bigrounded " type="submit" id="submit" name="submit" value="Tetapkan Pass" onclick="javascript:return confirm('Anda Yakin Untuk Melanjutkan ?')" /></td><td><img src="images/new/login.png"  width="100" height="100"/></td>
             </tr>
         </table>   
