...
$shipper = $data->val($i, 90);
$negaraasal = $data->val($i, 91);
$tonage_groos = $data->val($i, 92);
$tonage_netto = $data->val($i, 93);
...
$recordstatuskonf = $data->val($i, 171);
$jawabanstatuskonfirmasip2 = $data->val($i, 172);
$validasibcf15baru = $data->val($i, 173);
$tglvalidasibcf15 = $data->val($i, 174);
$perlukonf = $data->val($i, 175);
...
KepLimit1Date,
SuratSewaGudang1No,
SuratSewaGudang1Date,
JawabanSewaGudang1No,
JawabanSewaGudang1Date,
StatusLelang1Code,
StatusLelang1Date,
KepLelang2No,
KepLelang2Date,
...
KepLimit2Date,
SuratSewaGudang2No,
SuratSewaGudang2Date,
JawabanSewaGudang2No,
JawabanSewaGudang2Date,
StatusLelang2Code,
StatusLelang2Date, 
SuratKePusatNo,
SuratKePusatDate,
...
JawabanPusatCode,
PersetujuanMenkeuNo,
PersetujuanMenkeuDate,
PersetujuanMenkeuCode,
KepMusnahNo,
KepMusnahDate,
TempatMusnah,
...
SuratSewaTempatDate,
JawabanSewaTempatNo,
JawabanSewaTempatDate,
UsulanBMNKePusatNo,
UsulanBMNKePusatDate,
UsulanBMNKePusatCode,
JawabanBMNPusatNo, 
JawabanBMNPusatDate,
JawabanBMNPusatCode,
PersetujuanMKNo,
