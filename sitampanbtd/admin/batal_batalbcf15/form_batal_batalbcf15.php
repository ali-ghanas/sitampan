...
<html>
        ...
        <script type="text/javascript">
           $(document).ready(function() {    
              $("#ndkonfirmasi").submit(function() {
                 ...
                 if ($.trim($("#dasar_no_srt_batal").val()) == "") {
                    alert("<?php session_start(); echo " $_SESSION[nm_lengkap]..." ?> Masukan No Surat Dasar Pembatalan BCF 1.5");
                    $("#dasar_no_srt_batal").focus();
                    return false;  
                 }
                  if ($.trim($("#alasan_dibatalkan").val()) == "") {
                    alert("<?php session_start(); echo " $_SESSION[nm_lengkap]..." ?> Masukkan alasan");
                    $("#alasan_dibatalkan").focus();
                    return false;  
                 }
    ...
    <body>
	     ...
	     <?php // aksi untuk edit
            ...
            $alasan_dibatalkan=$_POST['alasan_dibatalkan'];
            $dasar_no_srt_batal=$_POST['dasar_no_srt_batal'];
            $dasar_tgl_srt_batal=$_SESSION['dasar_tgl_srt_batal'];
	...
	{            
                ...
                $update_konf = mysql_query("UPDATE bcf15 SET
                ...
                $insert = mysql_query("INSERT INTO batal_pembatalanbcf15(
                        idbcf15,
                        setujubatalno,
                        setujubataldate,
                        alasan_dibatalkan,
		...
		VALUES(
                ...
                if($insert){
                    echo "<script type='text/javascript'>window.location='index.php?hal=batal_btlbcf'</script>";
                }
                else {echo "gagal";}
	...
	$bcf15 = mysql_fetch_array($query);
        ...
        ?>
        <form method="post" id="ndkonfirmasi" name="ndkonfirmasi" action="?hal=form_batal_btlbcf">
        ...
        <input type="hidden" name="bc11subpos" value="<?php echo $bcf15['bc11subpos']; ?>" />
        <input type="hidden" name="SetujuBatalDate" value="<?php echo $bcf15['SetujuBatalDate']; ?>" />
        <input type="hidden" name="SetujuBatalNo" value="<?php echo $bcf15['SetujuBatalNo']; ?>" />
            ...
            <tr valign="top">
                <td colspan="4">
                    <table class="data isitabel" bgcolor="#eeefff">
                        ...
                        $data = mysql_fetch_array($querykonf);
                        ?>
                        <tr class="isitabel">
                            <td>
                        ...
                        <?php 
                         $queryloket  = "SELECT * FROM arsip_loket_pembatalan where idbcf15='$id' and jenis_dok='2'";
                         $hasil  = mysql_query($queryloket);
            ...
            <tr valign="top">
                <td colspan="4">
                    <table class="data isitabel" bgcolor="#eeefff">
                        <tr>
                                <td colspan="6" align="center" bgcolor="#95b0cb">
                                    <font size="3">Persetujuan Pembatalan BCF 1.5</font>
                                </td>
                         </tr>
                        <tr class="isitabel">
                            <td>
                                <font color="#000">Nomor</font>
                            </td>
                            <td>
                                <font color="#000">:</font>
                            </td>
                            <td>
                                <?php echo $bcf15['SetujuBatalNo'] ?>
                            </td>
                        </tr>
                        <tr class="isitabel">
                            <td>
                            ...
                            <td>
                                <?php echo tglindo($bcf15['SetujuBatalDate']) ?>
                            </td>
                        </tr>
            ...
            <tr valign="top">
                <td colspan="4">
                    ...
                    <table class="data isitabel" bgcolor="#153351">
                        ...
                        <tr>
                            <td>
                                <font color="#fff">Dasar Pembatalan</font>
                            </td>
                            <td>
                                <font color="#fff">:</font>
                            </td>
                            <td>
                                <textarea type="text" id="dasar_surat" name="dasar_surat" ><?php echo $_POST['dasar_surat']; ?> </textarea>
                        ...
                        <tr>
                            <td>
                                <font color="#fff">No / Tgl Dasar Surat Pembatalan</font>
                            </td>
                            <td>
                                <font color="#fff">:</font>
                            </td>
                            <td>
                                <input type="text"  name="dasar_no_srt_batal" id="dasar_no_srt_batal" value="<?php echo $_POST['dasar_no_srt_batal'] ?>"/> /  <input type="text" id="tanggal1" name="dasar_tgl_srt_batal" value="<?php echo $_POST['dasar_tgl_srt_batal']; ?>"/>
                        ...
                        <tr>
                            <td>
                                <font color="#fff">Uraikan alasan dibatalkan Persetujuan Pembatalan BCF 1.5 ini</font>
                            </td>
                            <td>
                                <font color="#fff">:</font>
                            </td>
                            <td>
                                <textarea cols="50" rows="3" name="alasan_dibatalkan" id="alasan_dibatalkan"><?php echo $_POST['alasan_dibatalkan']; ?></textarea>
            ...
            <tr><td ><input type="submit" name="submit1" value="Batalkan Status Pembatalan BCF 1.5" class="button putih " onclick="javascript:return confirm('Anda Yakin Untuk Membatalkan Persetujuan Pembatalan BCF 1.5 ini?')"  /></td><td colspan="2"><input class="button putih bigrounded" type="button" value="Cancel" onclick="self.history.back()" /></td></tr>
