...
$SetujuBatalNo = $data->val($i, 8);
$SetujuBatalNo2 = $data->val($i, 9);
$SetujuBatalDate = $data->val($i, 10);
$DokumenCode = $data->val($i, 11);
$DokumenNo = $data->val($i, 12);
$DokumenDate = $data->val($i, 13);
$Dokumen2Code = $data->val($i, 14);
$Dokumen2No = $data->val($i, 15);
$Dokumen2Date = $data->val($i, 16);

$jalur = $data->val($i, 17);
$ndkonfirmasijawaban = $data->val($i, 18);
$jawabanp2Ket = $data->val($i, 19);
$jawabanp2 = $data->val($i, 20);
$jawabanp2date = $data->val($i, 21);
$idseksisetujubatal=$data->val($i, 22);
$setujubatal=$data->val($i, 23);
$idseksip2ndkonfjwb=$data->val($i, 24);
