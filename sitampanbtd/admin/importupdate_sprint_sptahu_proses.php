...
<body>
    ...
    Persentase pemrosesan hingga saat ini:
    </div>
    <div id="kemajuan"></div>
        ...
        $masuk = $data->val($i, 16);
        $bamasukno = $data->val($i, 17);
        $bamasukdate = $data->val($i, 18);
        $BatalTarik = $data->val($i, 19);
        $BatalTarikNo = $data->val($i, 20);
        $BatalTarikNo2 = $data->val($i, 21);
        $BatalTarikDate = $data->val($i, 22);
