...
//$nourut=1;
?>
<form method="post" action=<?php echo "index.php?hal=pageadmin&pilih=user"; ?> >
...
$reload = "index.php?hal=adminbrowseuser";
...
<table class="data" >
	...
	<th class="judultabel" colspan="4">Action</th>
	</tr>
...
<td class="isitabel"><?php if($data['status_user']=='aktif') echo " <font >$data[status_user]</font>"; else { echo " <font color=red>$data[status_user]</font>";} ?></td>

<td align="center" class="isitabel"><?php if($data['status_user']=='aktif'){ echo "<a href=?hal=adminuseredit&id=$data[iduser]; >Edit</a> ";} else {echo "";} ?>
</td>
<td align="center" class="isitabel"><?php if($data['status_user']=='aktif'){ echo "<a href=?hal=adminuserdel&id=$data[iduser]; >Delete</a> ";} else {echo "<a href=?hal=adminuserundel&id=$data[iduser]; >Aktifkan</a> ";} ?>
</td>
<td align="center" class="isitabel"><?php if($data['status_user']=='aktif'){ echo "<a href=?hal=resetpass&id=$data[iduser]; >Reset Password</a> ";} else {echo "";} ?></td>
<td align="center" class="isitabel"><?php if($data['status_user']=='aktif'){ echo "<a href=?hal=addlevel&id=$data[iduser]; >Tambah Level</a> ";} else {echo "";} ?></td>
</tr>
<?php
};
?>
