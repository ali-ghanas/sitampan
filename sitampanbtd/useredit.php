...
if(isset($_POST['editsubmit1'])) // jika tombol editsubmit ditekan
	{               
		...
		$edit = mysql_query("UPDATE user SET
					...
					WHERE iduser='$id'");
		echo "<script type='text/javascript'>window.location='index.php?hal=updateuser&id=$nip&kasta=$kasta'</script>";
        }
        else 
	{ 
	...
	$data = mysql_fetch_array($query);
        ...
        <form method="post" id="useredit" name="useredit" action="?hal=edit_user">
        ...
        <input type="hidden" name="kasta" value="<?php echo  $data['level']; ?>" />
            <table border="0">
                ...
                <tr>
                    ...
                    <td><input class="required" name="pangkat" size="40" type="text" value="<?php echo  $data['pangkat']; ?>" /></td>
                </tr>
                <tr>
                    <td class="judulform">Gol</td><td class="judulform">:</td>
                    <td><input class="required" name="gol" size="40" type="text" value="<?php echo  $data['gol']; ?>" /></td>
                </tr>
                <tr>
...
<!--                <tr><td class="judulform">Hak Akses</td><td class="judulform">:</td><td> <select  class="required" id="akses" name="akses">
