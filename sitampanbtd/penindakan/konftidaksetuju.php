...
//                                  echo "<table bgcolor=#339cdf><tr><td><font face=verdana color=#fff><b>Dibawah ini adalah Konfirmasi BCF 1.5 yang telah dijawab dan/atau telah selesai dibatalkan BCF 1.5 </b></font></td></tr></table></br>";
                    ...
                    <form method="post" action=<?php echo "index.php?hal=daftarconf&pilihp2=hardcopy"; ?> >
                    <table border="0" >
                    ...
                    $reload = "index.php?hal=daftarconf&pilihp2=hardcopy";

                    // data mentah ,
                    $sql = "SELECT kofirmasi_p2.idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,consignee,notify
                        FROM kofirmasi_p2,bcf15 where bcf15.idbcf15=kofirmasi_p2.idbcf15 and   (konf_statusakhir='konf_hardcopy'  ) and ".$bagianWhere."   ";
                    ...
                    $sqltampil = "SELECT kofirmasi_p2.idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,consignee,notify
                        FROM kofirmasi_p2,bcf15 where bcf15.idbcf15=kofirmasi_p2.idbcf15 and  (konf_statusakhir='konf_hardcopy'  ) and ".$bagianWhere."    LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT kofirmasi_p2.idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,consignee,notify
                        FROM kofirmasi_p2,bcf15 where bcf15.idbcf15=kofirmasi_p2.idbcf15 and    (konf_statusakhir='konf_hardcopy'  )   ";
                    $result = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT kofirmasi_p2.idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,consignee,notify
                        FROM kofirmasi_p2,bcf15 where bcf15.idbcf15=kofirmasi_p2.idbcf15 and  (konf_statusakhir='konf_hardcopy'  )  LIMIT $limit,$rpp" ;
                   ...
                   <br/>
                    ...
                    <td align=center class="isitabel"><?php echo  $data['ip_usertpp']; ?></td>
