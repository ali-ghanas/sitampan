    ...
    <head>
       ...
       <link rel="stylesheet" type="text/css" href="../themes/main.css" />
                   ...
                   session_start();
                    ...
                    $tgl = $_POST['tgl']; // menangkap tgl1
                    $tgl2 = $_POST['tgl2'];// menangkap tgl2
                     $idp2 = $_POST['idp2'];// menangkap penindakan berapa
                    $sql = "SELECT * FROM kofirmasi_p2,bcf15 WHERE bcf15.idbcf15=kofirmasi_p2.idbcf15 and  konf_tglkonfp2 between '$tgl%' and '$tgl2' and ndkonfirmasito='$idp2' "; // memanggil data dengan id yang ditangkap tadi
...
<body>
    <p><font size="5" color="blue">Rekapitulasi Konfirmasi BCF 1.5 Per Tgl <?php echo tglindo($tgl) ?> sd <?php echo tglindo($tgl2) ?></font></p>
        <form name="form1" method="post" action="../report/export/lap_excel_penindakan_rekap.php">
        ...
        <input name="idp2" class="required" type="hidden" value="<?php echo $idp2 ?>" />
        <input type="submit" value="Download To Excell" name="search"/>
                    ...
                    <td class="isitabel" valign="top"><?php if($data['konf_stsblokir']=='Blokir') {echo  "<font color=red>$data[konf_stsblokir]</font>";} elseif($data['konf_stsblokir']=='Tidak') {echo "Tidak Terblokir";} elseif($data['konf_stsblokir']=='') {echo "N/A";} ?> <br/> <?php if($data['konf_stssegel']=='Segel') {echo  "<font color=red>$data[konf_stssegel]</font>";} elseif ($data['konf_stssegel']=='Tidak') {echo "Tidak Tersegel";} elseif ($data['konf_stssegel']=='') {echo "N/A";} ?> <br/> <?php if($data['konf_stsnhi']=='NHI'){ echo  "<font color=red>$data[konf_stsnhi]</font>";} elseif($data['konf_stsnhi']=='Tidak') {echo "Tidak NHI";} elseif($data['konf_stsnhi']=='') {echo "N/A";} ?></td>
