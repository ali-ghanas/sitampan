...
<html>
        ...
        <script type="text/javascript">
           $(document).ready(function() {    
              $("#ndkonfirmasi").submit(function() {
                 ...
                 if ($.trim($("#catatanp2").val()) == "") {
                    alert("<?php session_start(); echo " $_SESSION[nm_lengkap]..." ?> Jawaban Konfirmasi tidak boleh kosong");
                    $("#catatanp2").focus();
                    return false;  
                 }
	...
	{            
		...
		if($konf_stsblokir=='Blokir') {
                    $update_konf = mysql_query("UPDATE konf_p2_kembali SET
                                                        
                                                       catatanp2='$catatanp2',
                                                       nm_petugasp2='$nmrekam_batal',
                                                       nip_petugasp2='$niprekam_batal',
                                                       tgl_responp2='$now'
				...
				konf_statusakhir='konf_hardcopy',
                                ...
                                WHERE idbcf15='$id'");
                    echo "<table bgcolor=#202750><tr><td><img src=images/new/warning.png /></td><td><font size=5 color=#fff>Jawaban Konfirmasi Status Penyelesaian Blokir telah terkirim</font></td></tr></table></br>";
                    echo "<a href=?hal=daftarconf&pilihp2=masukhardcopykembali><<-Inbox Hardcopy->></a>"; 
                    
                    
               
                }
                if($konf_stssegel=='Segel') {
                    $update_konf = mysql_query("UPDATE konf_p2_kembali SET
				...
				konf_statusakhir='konf_hardcopy',
                                ...
                                WHERE idbcf15='$id'");
                    echo "<table bgcolor=#202750><tr><td><img src=images/new/warning.png /></td><td><font size=5 color=#fff>Jawaban Konfirmasi Status Penyelesaian Segel telah terkirim</font></td></tr></table></br>";
                    echo "<a href=?hal=daftarconf&pilihp2=masukhardcopykembali><<-Inbox Hardcopy->></a>"; 
				...
				konf_statusakhir='konf_hardcopy',
                                ...
                                WHERE idbcf15='$id'");
                    echo "<table bgcolor=#202750><tr><td><img src=images/new/warning.png /></td><td><font size=5 color=#fff>Jawaban Konfirmasi Status Penyelesaian NHI telah terkirim</font></td></tr></table></br>";
                    echo "<a href=?hal=daftarconf&pilihp2=masukhardcopykembali><<-Inbox Hardcopy->></a>"; 
	...
	$bcf15 = mysql_fetch_array($query);
        ...
        ?>
        <form method="post" id="ndkonfirmasi" name="ndkonfirmasi" action="?hal=daftarconf&pilihp2=jawabhardcopy_kembali">
        <input type="hidden" name="id" value="<?php echo  $bcf15['idbcf15']; ?>" />
            ...
            <tr valign="top">
                ...
                <?php
                        $sqlkonfKEMBALI = "SELECT * FROM konf_p2_kembali where  idbcf15=$bcf15[idbcf15]"; // memanggil data dengan id yang ditangkap tadi
                        $queryKEMBALI = mysql_query($sqlkonfKEMBALI);
                        $dataKEMBALI = mysql_fetch_array($queryKEMBALI);
                        ?>
            <tr valign="top">
                <td colspan="4">
                    <table class="data isitabel" bgcolor="#eeefff">
                        <tr>
                                <td colspan="6" align="center" bgcolor="#95b0cb">
                                    <font size="3">KONFIRMASI PENYELESAIAN NHI/BLOKIR/SEGEL</font>
                                </td>
                         </tr>
                        <tr class="isitabel">
                            <td>
                            ...
                            <td>
                               <?php echo $dataKEMBALI['catatanpenimbunan'] ?> 
                            </td>
                        </tr>
                        <tr class="isitabel">
                            <td>
                                <font color="#000">PETUGAS PENIMBUNAN</font>
                            </td>
                            <td>
                                <font color="#000">:</font>
                            </td>
                            <td>
                               <?php echo $dataKEMBALI['nm_petugaspenimbunan'] ?>  <?php echo $dataKEMBALI['nip_petugaspenimbunan'] ?> 
                            </td>
                        </tr>
                        <tr class="isitabel">
                            <td>
                                <font color="#000">TGL KONF</font>
                            </td>
                            <td>
                                <font color="#000">:</font>
                            </td>
                            <td>
                               <?php echo $dataKEMBALI['tgl_responpenimbunan'] ?>  
                            </td>
                        </tr>
            ...
            <tr valign="top">
                <td colspan="4">
                    ...
                    <table class="data isitabel" bgcolor="#153351">
                        <tr>
                                <td colspan="6" align="center" bgcolor="#95b0cb">
                                    <font size="3">Penyelesaian Status NHI/SEGEL/ BLOKIR</font>
                                </td>
                         </tr>
                         <?php
                        if($data[konf_stsblokir]==Blokir){
                            echo "<tr>";
                            echo "<td>
                        ...
                        <tr>
                            <td class="isitabel">
                                <font color="#fff" >Catatan Konfirmasi P2  <br/> 
                                isikan catatan perihal jawaban atas konfirmasi ulang <br/>status barang tersebut kepada Seksi Penimbunan <br/>dalam rangka pembatalan BCF 1.5
                                </font>
                            </td>
                            <td>
                                <font color="#fff">:</font>
                            ...
                            <td>
                                <textarea cols="50" rows="5" type="text" id="catatanp2" name="catatanp2"></textarea> 
                            </td>
            ...
            <tr><td ><input type="submit" name="submit1" value="Balas Konfirmasi" class="button putih " onclick="javascript:return confirm('Balas Konfirmasi ?')"  /></td></tr>
