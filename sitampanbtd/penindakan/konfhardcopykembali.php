...
//                                  echo "<table bgcolor=#339cdf><tr><td><font face=verdana color=#fff><b>Dibawah ini adalah Konfirmasi BCF 1.5 yang telah dijawab dan/atau telah selesai dibatalkan BCF 1.5 </b></font></td></tr></table></br>";
                    ...
                    // data mentah ,
                    $sql = "SELECT *
                        FROM kofirmasi_p2,bcf15 where  bcf15.idbcf15=kofirmasi_p2.idbcf15 and  (konf_statusakhir='konfkembali_hardcopy'  ) and konf_manualhc='1' and konf_jwabanmanualhc='1'  and ".$bagianWhere."   ";
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT *
                        FROM kofirmasi_p2,bcf15 where  bcf15.idbcf15=kofirmasi_p2.idbcf15 and  (konf_statusakhir='konfkembali_hardcopy'  ) and konf_manualhc='1' and konf_jwabanmanualhc='1'  and ".$bagianWhere."    LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT *
                        FROM kofirmasi_p2,bcf15 where  bcf15.idbcf15=kofirmasi_p2.idbcf15 and  (konf_statusakhir='konfkembali_hardcopy'  ) and konf_manualhc='1' and konf_jwabanmanualhc='1'   ";
                    $result = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT *
                        FROM kofirmasi_p2,bcf15 where  bcf15.idbcf15=kofirmasi_p2.idbcf15 and  (konf_statusakhir='konfkembali_hardcopy'  ) and konf_manualhc='1' and konf_jwabanmanualhc='1'  LIMIT $limit,$rpp" ;
                   ...
                   <br/>
                    ...
                    <table class="data" >
                            ...
                            <th class="judultabel"  colspan="3">ND Konfirmasi Penimbunan</th>
                            <th class="judultabel"  colspan="3">ND Konfirmasi P2</th>
                    ...
                    while($data = mysql_fetch_array($tampil)){
                      if($data['konf_statusakhir']=='konf_hardcopy') {$status='Kirim Hardcopy';} elseif($data['konf_statusakhir']=='konf_system') {$status='Konf BCF 1.5 by sistem';} elseif($data['konf_statusakhir']=='konf_jawabok') {$status='Konf dijawab by System';} elseif($data['konf_statusakhir']=='konf_selesai') {$status='Konfirmasi Selesai';} elseif($data['konf_statusakhir']=='konfkembali_hardcopy') {$status='Konfirmasi Kembali Hard Copy';} 
                    ...
                    <td class="isitabel">Nama :<?php echo  $data['nm_usertppmanual']; ?><br/> Nip : <?php echo  $data['nip_usertppmanual']; ?> <br/></td>
                     ...
                     <td align=center class="isitabel"><?php echo  $data['konf_nondp2']; ?></td>
                    <td class="isitabel"><?php echo  $data['konf_tglndp2']; ?></td>
                    <td class="isitabel">Nama :<?php echo  $data['nm_userp2manual']; ?><br/> Nip : <?php echo  $data['nip_usertppmanual']; ?> <br/></td>
                    
                    
                    
                    <td class="isitabel"><?php echo  $status; ?></td>
                    <td class="isitabel"><a href="?hal=daftarconf&pilihp2=jawabhardcopy_kembali&id=<?php echo $data['idbcf15']?>">Jawab</a></td>
