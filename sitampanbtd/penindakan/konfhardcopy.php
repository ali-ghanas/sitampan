...
//                                  echo "<table bgcolor=#339cdf><tr><td><font face=verdana color=#fff><b>Dibawah ini adalah Konfirmasi BCF 1.5 yang telah dijawab dan/atau telah selesai dibatalkan BCF 1.5 </b></font></td></tr></table></br>";
                    ...
                    <form method="post" action=<?php echo "index.php?hal=daftarconf&pilihp2=masukhardcopy"; ?> >
                    <table border="0" >
                    ...
                    $reload = "index.php?hal=daftarconf&pilihp2=masukhardcopy";

                    // data mentah ,
                    $sql = "SELECT kofirmasi_p2.idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,konf_nondtpp,konf_tglndtpp,nm_usertppmanual,nip_usertppmanual,ip_usertppmanual,idseksitpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,nm_seksi,consignee,notify
                        FROM kofirmasi_p2,seksi,bcf15 where kofirmasi_p2.idseksitpp=seksi.idseksi and bcf15.idbcf15=kofirmasi_p2.idbcf15 and  (konf_statusakhir='konf_hardcopy'  ) and konf_manualhc='1' and konf_jwabanmanualhc='0' and ".$bagianWhere."   ";
                    ...
                    $sqltampil = "SELECT kofirmasi_p2.idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,konf_nondtpp,konf_tglndtpp,nm_usertppmanual,nip_usertppmanual,ip_usertppmanual,idseksitpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,nm_seksi,consignee,notify
                        FROM kofirmasi_p2,seksi,bcf15 where kofirmasi_p2.idseksitpp=seksi.idseksi and bcf15.idbcf15=kofirmasi_p2.idbcf15 and  (konf_statusakhir='konf_hardcopy'  ) and konf_manualhc='1' and konf_jwabanmanualhc='0' and ".$bagianWhere."    LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT kofirmasi_p2.idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,konf_nondtpp,konf_tglndtpp,nm_usertppmanual,nip_usertppmanual,ip_usertppmanual,idseksitpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,nm_seksi,consignee,notify
                        FROM kofirmasi_p2,seksi,bcf15 where kofirmasi_p2.idseksitpp=seksi.idseksi and bcf15.idbcf15=kofirmasi_p2.idbcf15 and  (konf_statusakhir='konf_hardcopy'  ) and konf_manualhc='1' and konf_jwabanmanualhc='0'  ";
                    $result = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT kofirmasi_p2.idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,konf_nondtpp,konf_tglndtpp,nm_usertppmanual,nip_usertppmanual,ip_usertppmanual,idseksitpp,konf_statusakhir,konf_tglkonfp2,konf_stsblokir,konf_stssegel,konf_stsnhi,status_ket,nm_userp2,nip_userp2,ip_userp2,catatan_userp2,konf_lewatjam,nm_seksi,consignee,notify
                        FROM kofirmasi_p2,seksi,bcf15 where kofirmasi_p2.idseksitpp=seksi.idseksi and bcf15.idbcf15=kofirmasi_p2.idbcf15 and  (konf_statusakhir='konf_hardcopy'  ) and konf_manualhc='1' and konf_jwabanmanualhc='0'  LIMIT $limit,$rpp" ;
                   ...
                   <br/>
                    ...
                    <table class="data" >
                            ...
                            <th class="judultabel"  colspan="5">Konfirmasi Hardcopy</th>
                            ...
                            <tr>
                                ...
                                <th class="judultabel">Lewat Bts Waktu</th>
                                <th class="judultabel">Tgl Respon</th>
                                ...
                                <th class="judultabel">Petugas</th>
                                <th class="judultabel">Seksi Penimbunan</th>
                    ...
                    <td align=center class="isitabel"><?php echo  $respon; ?></td>
                    ...
                    <td align=center class="isitabel"><?php echo  $data['konf_nondtpp']; ?></td>
                    <td class="isitabel"><?php echo  $data['konf_tglndtpp']; ?></td>
                    <td class="isitabel">Nama :<?php echo  $data['nm_usertppmanual']; ?><br/> Nip : <?php echo  $data['nip_usertppmanual']; ?> <br/></td>
                    
                    <td class="isitabel"><?php echo  $data['nm_seksi']; ?></td>
                    <td class="isitabel"><?php echo  $data['ip_usertppmanual']; ?></td>
                    
                    <td class="isitabel"><?php echo  $status; ?></td>
                    <td class="isitabel"><a href="?hal=daftarconf&pilihp2=jawabhardcopy&id=<?php echo $data['idbcf15']?>">Jawab</a></td>
