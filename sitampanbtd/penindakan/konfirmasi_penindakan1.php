...
<html>
    ...
    <body>
                   ...
                   <?php // yang belum koneksi database diabaikan aja dulu file ini
                    ...
                    //ambildata mentah
                    $sql1 = "SELECT konf_bcf15no,bcf15.idbcf15,konf_statusakhir,konf_btstgl,ndkonfirmasito FROM kofirmasi_p2,bcf15 where bcf15.idbcf15=kofirmasi_p2.idbcf15 and  konf_statusakhir='konf_system' and ndkonfirmasito='1' and  konf_btstgl < '$now' ";
...
//                    
                    ...
                    <form method="post" action=<?php echo "index.php?hal=daftarconf&pilihp2=newkonf_penindakan1"; ?> >
                    <table border="0" >
                    ...
                    $reload = "index.php?hal=daftarconf&pilihp2=newkonf_penindakan1";

                    // data mentah ,
                    $sql = "SELECT kofirmasi_p2.idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,consignee,notify
                        FROM kofirmasi_p2,bcf15 where bcf15.idbcf15=kofirmasi_p2.idbcf15 and   (konf_statusakhir='konf_system') and ndkonfirmasito='1' and ".$bagianWhere."   ";
                    ...
                    // counting the offset
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT kofirmasi_p2.idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,consignee,notify
                        FROM kofirmasi_p2,bcf15 where bcf15.idbcf15=kofirmasi_p2.idbcf15 and  (konf_statusakhir='konf_system') and ndkonfirmasito='1' and ".$bagianWhere."    LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT kofirmasi_p2.idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,consignee,notify
                        FROM kofirmasi_p2,bcf15 where bcf15.idbcf15=kofirmasi_p2.idbcf15 and   (konf_statusakhir='konf_system') and ndkonfirmasito='1'   ";
                    $result = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT kofirmasi_p2.idbcf15,konf_bcf15no,konf_bcf15tgl,konf_tahun,konf_bc11no,konf_bc11tgl,konf_bc11pos,konf_bc11psubpos,konf_tglkonftpp,nm_usertpp,nip_usertpp,ip_usertpp,konf_statusakhir,consignee,notify
                        FROM kofirmasi_p2,bcf15 where bcf15.idbcf15=kofirmasi_p2.idbcf15 and   (konf_statusakhir='konf_system') and ndkonfirmasito='1'   LIMIT $limit,$rpp" ;
