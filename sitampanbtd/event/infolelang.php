...
<html>
  ...
  <body >   
      <?php 
        $sql = "select * FROM event WHERE publish='1' and idevenkategori='1'"; // memanggil data dengan id yang ditangkap tadi
	...
	$cek=mysql_numrows($query);
       ...
       ?>
          <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                      <td><a href="?pilih=info_lelang_detail&id=<?php echo $data['idevent'] ?>"><?php echo $data['judulevent'] ?></a></td>
