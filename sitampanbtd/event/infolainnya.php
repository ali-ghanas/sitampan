...
<html>
  ...
  <body >   
      <?php 
        $sql = "select * FROM event WHERE publish='1' and idevenkategori='6'"; // memanggil data dengan id yang ditangkap tadi
          ...
          <table class="table table-striped">
                ...
                <?php 
                     if($cek<0){
                       echo "<tbody>
                                <tr>
                                    <td colspan='3'>Tidak Event Terbaru</td>
                                </tr>
                            </tbody>" ;
                     }
                     else {
                ...
                <tbody>
                  <tr>
                      <td><a href="?pilih=info_lainnya_detail&id=<?php echo $data['idevent'] ?>"><?php echo $data['judulevent'] ?></a></td>
