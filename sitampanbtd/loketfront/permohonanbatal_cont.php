...
<html>
    ...
    <body>
                    ...
                    */
                    ...
                    <form method="post" action=<?php echo "index.php?hal=pagefront&pilih=permohonanbatal_cont"; ?> >
                    <table border="0">
                        
                        <tr>
                            <td colspan="3"><a href="?hal=pagefront&pilih=permohonanbatal">Cari BCF 1.5</a> | <a href="?hal=pagefront&pilih=permohonanbatal_cont">Cari Container</a></td>
                        </tr>
                        <tr>
                            <td height="20"></td>
                        </tr>
                    ...
                    $reload = "index.php?hal=pagefront&pilih=permohonanbatal_cont";
