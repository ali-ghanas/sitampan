...
<html>
    ...
    <body>
                    ...
                    ?>
                    <table width="100%"><tr><td class="judultabel1">Permohonan Pembatalan BCF 1.5 Yang Telah Lengkap</td></tr></table>
                    <form method="post" action=<?php echo "index.php?hal=pagefront&pilih=daftardoklengkap"; ?> >
                    <table border="0">
                    ...
                    $reload = "index.php?hal=pagefront&pilih=daftardoklengkap";
                    ...
                    $sql = "SELECT idbcf15,bcf15no,bcf15.tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,Pemohon,NoKepStatus_Akhr
                        FROM bcf15,tpp,typecode,suratmasukpembatalanbcf15  where bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and bcf15.idbcf15=suratmasukpembatalanbcf15.noidbcf15 and recordstatus='2' and setujubatal='2' and lengkap='1' and ".$bagianWhere."   order by bcf15.idbcf15 desc ";
                    ...
                    $sqltampil = "SELECT idbcf15,bcf15no,bcf15.tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,Pemohon,NoKepStatus_Akhr
                        FROM bcf15,tpp,typecode,suratmasukpembatalanbcf15  where bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and bcf15.idbcf15=suratmasukpembatalanbcf15.noidbcf15 and recordstatus='2' and setujubatal='2' and lengkap='1' and ".$bagianWhere."  order by bcf15.idbcf15 desc  LIMIT $limit,$rpp";
                    ...
                    // data mentah 
                    $sql = "SELECT idbcf15,bcf15no,bcf15.tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,Pemohon,NoKepStatus_Akhr
                        FROM bcf15,tpp,typecode,suratmasukpembatalanbcf15  where bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and bcf15.idbcf15=suratmasukpembatalanbcf15.noidbcf15 and recordstatus='2' and setujubatal='2' and lengkap='1' order by idbcf15 desc ";
                    $result = mysql_query($sql);
                    ...
                    $limit = ($nohal - 1) * $rpp;
                    $sqltampil = "SELECT idbcf15,bcf15no,bcf15.tahun,bcf15tgl,bc11no,bc11tgl,bc11pos,bc11subpos,blno,bltgl,consignee,notify,idtps,bcf15.idtpp,tpp.idtpp,nm_tpp,shipper,negaraasal,bamasukno,BatalTarikNo,SuratBatalNo,SetujuBatalNo,bamasukdate,diskripsibrg,bcf15.idtypecode,typecode.idtypecode,nm_type,Pemohon,NoKepStatus_Akhr
                        FROM bcf15,tpp,typecode,suratmasukpembatalanbcf15  where bcf15.idtypecode=typecode.idtypecode and  bcf15.idtpp=tpp.idtpp and bcf15.idbcf15=suratmasukpembatalanbcf15.noidbcf15 and recordstatus='2' and setujubatal='2' and lengkap='1'  order by idbcf15 desc  LIMIT $limit,$rpp" ;
        ...
        <br/>
                    ...
                    <td align="center" class="isitabel"> <?php if ($data['SuratBatalNo']=='') {echo "<a href='?hal=pagefront&pilih=distribusi&id=$data[idbcf15]' target='_self'><img src=\"images/new/update.png\" ></img></a> ";}   else {echo "<a href='?hal=pagefront&pilih=distribusi&id=$data[idbcf15]' target='_self'><img src=\"images/new/update.png\" ></img></a>"; } ?>
                    </td>
