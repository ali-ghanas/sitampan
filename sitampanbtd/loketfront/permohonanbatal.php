...
<html>
    ...
    <body>
                    ...
                    */
                    ...
                    <form method="post" action=<?php echo "index.php?hal=pagefront&pilih=permohonanbatal"; ?> >
                    <table border="0">
                        <tr>
                            <td ><hr/></td>
                        </tr>
                        ...
                        <tr bgcolor="#e4ebf1">
                            <td colspan="3"><a href="?hal=pagefront&pilih=permohonanbatal">Cari BCF 1.5</a> | <a href="?hal=pagefront&pilih=permohonanbatal_cont">Cari Container</a> | <a href="?hal=bukaposbc11">Buka Pos BC 1.1 Ceisa</a></td>
                        </tr>
                        <tr>
                            <td ><hr/></td>
                        </tr>
                    ...
                    $reload = "index.php?hal=pagefront&pilih=permohonanbatal";
        ...
        <br/>
                    ...
                    <td align="center" class="isitabel"> <?php if ($data['SuratBatalNo']=='') {echo "<a href='?hal=pagefront&pilih=inputpermohonan&id=$data[idbcf15]' target='_self'><img src=\"images/new/update.png\" ></img></a> ";}   else {echo "<a href='?hal=pagefront&pilih=inputpermohonan&id=$data[idbcf15]' target='_self'><img src=\"images/new/update.png\" ></img></a>"; } ?>
                    </td>
