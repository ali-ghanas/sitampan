...
<html>
    ...
    <body>
                    ...
                    */
                    ...
                    <form method="post" action=<?php echo "index.php?hal=pagefront&pilih=browsestrip"; ?> >
                    <table border="0">
                        <tr>
                            <td ><hr/></td>
                        </tr>
                        ...
                        <tr bgcolor="#e4ebf1">
                            <td colspan="3"><font color=""><b>BROWSE BCF 1.5 (PEREKAMAN PERMOHONAN STRIPPING CONTAINER)</b></font></td>
                        </tr>
                        <tr>
                            <td ><hr/></td>
                        </tr>
                    ...
                    $reload = "index.php?hal=pagefront&pilih=browsestrip";
        ...
        <br/>
                    ...
                    <td align="center" class="isitabel"> <a href="?hal=pagefront&pilih=formstriping&id=<?php echo "$data[idbcf15]"; ?>">Rekam</a>
                    </td>
