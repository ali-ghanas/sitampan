...
while ($selectfromtblanalisispenumpangsumberarray=mysql_fetch_array($selectfromtblanalisispenumpangsumber)) {
	...
	$selectfromtblpenumpangprofil=mysql_query("select
		penumpangnama,penumpangjeniskelamin,penumpangwaktulahir,penumpangpasporno
		from tblpenumpangprofil
		where penumpangnama='".$penumpangnama."' and penumpangjeniskelamin='".$penumpangjeniskelamin."' and penumpangpasporno='".$penumpangpasporno."'
	");
	while ($selectfromtblpenumpangprofilarray=mysql_fetch_array($selectfromtblpenumpangprofil)) {
?>
	...
	<?php jar(); ?>
		<td width="170" align="left" style="max-width:170px; overflow:hidden;"><strong><?php echo($selectfromtblpenumpangprofilarray["penumpangnama"]); ?></strong></td>
	<?php jar(); ?>
		<td width="30" align="center"><?php echo($selectfromtblpenumpangprofilarray["penumpangjeniskelamin"]); ?></td>
	<?php jar(); ?>
		<td width="70" align="center" style="max-width:70px; overflow:hidden;"><?php echo(funconvtanggalmiring($selectfromtblpenumpangprofilarray["penumpangwaktulahir"])); ?></td>
	<?php jar(); ?>
		<td width="110" align="center" style="max-width:110px; overflow:hidden;"><?php echo($selectfromtblpenumpangprofilarray["penumpangpasporno"]); ?></td>
	<?php jar(); ?>
		</tr>
	</table></td></tr>
