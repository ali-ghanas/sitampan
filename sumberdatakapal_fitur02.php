...
<?php
$selectfromtblanalisispenumpangsumber=mysql_query("select penumpangnama,penumpangjeniskelamin,penumpangwaktulahir from tblanalisispenumpangsumber where sumberid='".$linsumberid."'");
$namvarnavsubline=1;
while ($selectfromtblanalisispenumpangsumberarray=mysql_fetch_array($selectfromtblanalisispenumpangsumber)) {
	...
	$selectfromtblanalisispenumpangsumber2=mysql_query("select
		...
		where penumpangnama='".$penumpangnama."' and penumpangjeniskelamin='".$penumpangjeniskelamin."' and penumpangwaktulahir='".$penumpangwaktulahir."'
...
?>
	...
	<?php jar(); ?>
		<td width="170" align="left" style="max-width:170px; overflow:hidden;"><?php echo($selectfromtblanalisispenumpangsumberarray2["penumpangnama"]); ?></td>
	<?php jar(); ?>
	...
	<?php jar(); ?>
		<td width="110" align="center" style="max-width:110px; overflow:hidden;"><strong><?php echo($selectfromtblanalisispenumpangsumberarray2["penumpangpasporno"]); ?></strong></td>
	<?php jar(); ?>
		</tr>
	</table></td></tr>
