...
$cekdatasrt=mysql_numrows($querysrt);
...
?>
    ...
    <div class="row">
      <div class="span9">
          <h3>Hasil Pencarian <i class='fa fa fa-search fa-3x' ></i></h3>
          <table class="table">
              <tr>
              ...
              <tr>
                  <td colspan="3">
                      <table width="100%">
                          <tr>
                              <td colspan="4" ><h4>Status Permohonan</h4></td>
                          </tr>
                          <tr>
                              <th>No</th>
                              <th>Uraian</th>
                          ...
                          <tr>
                              ...
                              <td><div class='alert alert-success'><h4 ><?php echo $setujubatal; echo $statussurat?></h4></div></td>
                          </tr>
                          <?php }else {echo "<tr><td colspan='5'><div class='alert alert-danger'><h4 >Tidak ada Permohonan Pembatalan BCF 1.5</h4></div></td></tr>";} ?>
                      </table>
                  </td>
              </tr>
          </table>
