...
<body>
    ...
    <div class="bingkaicontoh"><table >
        <tr class="data">
            <td class="judultabel">BMN</td>
            <td class="judultabel">Tgl(YYYY-MM-DD)</td>
...
<form method="post" enctype="multipart/form-data" action="?hal=uploadbmnproses">
